...
const _MemoryUnmapFlagBitsKHR_name = "MEMORY_UNMAP_RESERVE_BIT_EXT"

var _MemoryUnmapFlagBitsKHR_index = [...]uint8{0, 28}

func (i MemoryUnmapFlagBitsKHR) String() string {
	idx := int(i) - 1
	if i < 1 || idx >= len(_MemoryUnmapFlagBitsKHR_index)-1 {
		return "MemoryUnmapFlagBitsKHR(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _MemoryUnmapFlagBitsKHR_name[_MemoryUnmapFlagBitsKHR_index[idx]:_MemoryUnmapFlagBitsKHR_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i OpacityMicromapSpecialIndexEXT) String() string {
	idx := int(i) - -4
	if i < -4 || idx >= len(_OpacityMicromapSpecialIndexEXT_index)-1 {
		return "OpacityMicromapSpecialIndexEXT(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _OpacityMicromapSpecialIndexEXT_name[_OpacityMicromapSpecialIndexEXT_index[idx]:_OpacityMicromapSpecialIndexEXT_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i PipelineCacheCreateFlagBits) String() string {
	idx := int(i) - 1
	if i < 1 || idx >= len(_PipelineCacheCreateFlagBits_index)-1 {
		return "PipelineCacheCreateFlagBits(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _PipelineCacheCreateFlagBits_name[_PipelineCacheCreateFlagBits_index[idx]:_PipelineCacheCreateFlagBits_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
const _PipelineCreateFlagBits_name = "PIPELINE_CREATE_DISABLE_OPTIMIZATION_BITPIPELINE_CREATE_ALLOW_DERIVATIVES_BITPIPELINE_CREATE_DERIVATIVE_BITPIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BITPIPELINE_CREATE_DISPATCH_BASE_BITPIPELINE_CREATE_DEFER_COMPILE_BIT_NVPIPELINE_CREATE_CAPTURE_STATISTICS_BIT_KHRPIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHRPIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BITPIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BITPIPELINE_CREATE_LINK_TIME_OPTIMIZATION_BIT_EXTPIPELINE_CREATE_LIBRARY_BIT_KHRPIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHRPIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHRPIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHRPIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHRPIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHRPIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHRPIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NVPIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHRPIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NVPIPELINE_CREATE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRPIPELINE_CREATE_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXTPIPELINE_CREATE_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXTPIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_EXTPIPELINE_CREATE_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTPIPELINE_CREATE_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTPIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT_EXTPIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXTPIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT_EXT"
...
var _PipelineCreateFlagBits_map = map[PipelineCreateFlagBits]string{
	...
	134217728:  _PipelineCreateFlagBits_name[1347:1390],
	536870912:  _PipelineCreateFlagBits_name[1390:1431],
	1073741824: _PipelineCreateFlagBits_name[1431:1476],
}
...
const _PipelineCreateFlagBits2KHR_name = "PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT_KHRPIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT_KHRPIPELINE_CREATE_2_DERIVATIVE_BIT_KHRPIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHRPIPELINE_CREATE_2_DISPATCH_BASE_BIT_KHRPIPELINE_CREATE_2_DEFER_COMPILE_BIT_NVPIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHRPIPELINE_CREATE_2_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHRPIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHRPIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT_KHRPIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXTPIPELINE_CREATE_2_LIBRARY_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHRPIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NVPIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHRPIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NVPIPELINE_CREATE_2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRPIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXTPIPELINE_CREATE_2_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXTPIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXTPIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTPIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTPIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT_EXTPIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NVPIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXTPIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXTPIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT"

var _PipelineCreateFlagBits2KHR_map = map[PipelineCreateFlagBits2KHR]string{
	1:           _PipelineCreateFlagBits2KHR_name[0:46],
	2:           _PipelineCreateFlagBits2KHR_name[46:89],
	4:           _PipelineCreateFlagBits2KHR_name[89:125],
	8:           _PipelineCreateFlagBits2KHR_name[125:179],
	16:          _PipelineCreateFlagBits2KHR_name[179:218],
	32:          _PipelineCreateFlagBits2KHR_name[218:256],
	64:          _PipelineCreateFlagBits2KHR_name[256:300],
	128:         _PipelineCreateFlagBits2KHR_name[300:358],
	256:         _PipelineCreateFlagBits2KHR_name[358:417],
	512:         _PipelineCreateFlagBits2KHR_name[417:466],
	1024:        _PipelineCreateFlagBits2KHR_name[466:514],
	2048:        _PipelineCreateFlagBits2KHR_name[514:547],
	4096:        _PipelineCreateFlagBits2KHR_name[547:599],
	8192:        _PipelineCreateFlagBits2KHR_name[599:647],
	16384:       _PipelineCreateFlagBits2KHR_name[647:708],
	32768:       _PipelineCreateFlagBits2KHR_name[708:773],
	65536:       _PipelineCreateFlagBits2KHR_name[773:831],
	131072:      _PipelineCreateFlagBits2KHR_name[831:897],
	262144:      _PipelineCreateFlagBits2KHR_name[897:939],
	524288:      _PipelineCreateFlagBits2KHR_name[939:1011],
	1048576:     _PipelineCreateFlagBits2KHR_name[1011:1060],
	2097152:     _PipelineCreateFlagBits2KHR_name[1060:1128],
	4194304:     _PipelineCreateFlagBits2KHR_name[1128:1195],
	8388608:     _PipelineCreateFlagBits2KHR_name[1195:1255],
	16777216:    _PipelineCreateFlagBits2KHR_name[1255:1309],
	33554432:    _PipelineCreateFlagBits2KHR_name[1309:1365],
	67108864:    _PipelineCreateFlagBits2KHR_name[1365:1429],
	134217728:   _PipelineCreateFlagBits2KHR_name[1429:1474],
	268435456:   _PipelineCreateFlagBits2KHR_name[1474:1532],
	536870912:   _PipelineCreateFlagBits2KHR_name[1532:1575],
	1073741824:  _PipelineCreateFlagBits2KHR_name[1575:1622],
	17179869184: _PipelineCreateFlagBits2KHR_name[1622:1671],
}

func (i PipelineCreateFlagBits2KHR) String() string {
	if str, ok := _PipelineCreateFlagBits2KHR_map[i]; ok {
		return str
	}
