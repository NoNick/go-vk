// Code generated by go-vk from vk.xml at 2025-10-25 17:30:03.958074114 +0000 UTC m=+4.692407890. DO NOT EDIT.
...
// AntiLagUpdateAMD: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkAntiLagUpdateAMD.html
func AntiLagUpdateAMD(device Device, data *AntiLagDataAMD) {
	// Parameter is a singular input, requires translation - data
	var pData *_vkAntiLagDataAMD
	if data != nil {
		pData = data.Vulkanize()
	}

	execTrampoline(vkAntiLagUpdateAMD, uintptr(device), uintptr(unsafe.Pointer(pData)))

}

var vkAntiLagUpdateAMD = &vkCommand{"vkAntiLagUpdateAMD", 2, true, nil}
...
// BindDataGraphPipelineSessionMemoryARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkBindDataGraphPipelineSessionMemoryARM.html
func BindDataGraphPipelineSessionMemoryARM(device Device, bindInfos []BindDataGraphPipelineSessionMemoryInfoARM) (r error) {
	bindInfoCount := len(bindInfos)
	// bindInfos is an input slice that requires translation to an internal type
	var pBindInfos unsafe.Pointer
	if len(bindInfos) > 0 {
		sl_bindInfos := make([]_vkBindDataGraphPipelineSessionMemoryInfoARM, bindInfoCount)
		for i, v := range bindInfos {
			sl_bindInfos[i] = *(v.Vulkanize())
		}
		pBindInfos = unsafe.Pointer(&sl_bindInfos[0])
	...
	r = Result(execTrampoline(vkBindDataGraphPipelineSessionMemoryARM, uintptr(device), uintptr(bindInfoCount), uintptr(unsafe.Pointer(pBindInfos))))
...
var vkBindDataGraphPipelineSessionMemoryARM = &vkCommand{"vkBindDataGraphPipelineSessionMemoryARM", 3, true, nil}
...
// BindTensorMemoryARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkBindTensorMemoryARM.html
func BindTensorMemoryARM(device Device, bindInfos []BindTensorMemoryInfoARM) (r error) {
	bindInfoCount := len(bindInfos)
	// bindInfos is an input slice that requires translation to an internal type
	var pBindInfos unsafe.Pointer
	if len(bindInfos) > 0 {
		sl_bindInfos := make([]_vkBindTensorMemoryInfoARM, bindInfoCount)
		for i, v := range bindInfos {
			sl_bindInfos[i] = *(v.Vulkanize())
		}
		pBindInfos = unsafe.Pointer(&sl_bindInfos[0])
	...
	r = Result(execTrampoline(vkBindTensorMemoryARM, uintptr(device), uintptr(bindInfoCount), uintptr(unsafe.Pointer(pBindInfos))))
...
var vkBindTensorMemoryARM = &vkCommand{"vkBindTensorMemoryARM", 3, true, nil}
...
// CmdBeginPerTileExecutionQCOM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBeginPerTileExecutionQCOM.html
func CmdBeginPerTileExecutionQCOM(commandBuffer CommandBuffer, perTileBeginInfo *PerTileBeginInfoQCOM) {
	// Parameter is a singular input, requires translation - perTileBeginInfo
	var pPerTileBeginInfo *_vkPerTileBeginInfoQCOM
	if perTileBeginInfo != nil {
		pPerTileBeginInfo = perTileBeginInfo.Vulkanize()
	}

	execTrampoline(vkCmdBeginPerTileExecutionQCOM, uintptr(commandBuffer), uintptr(unsafe.Pointer(pPerTileBeginInfo)))

}

var vkCmdBeginPerTileExecutionQCOM = &vkCommand{"vkCmdBeginPerTileExecutionQCOM", 2, true, nil}
...
// CmdBindDescriptorSets2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBindDescriptorSets2.html
func CmdBindDescriptorSets2(commandBuffer CommandBuffer, bindDescriptorSetsInfo *BindDescriptorSetsInfo) {
	...
	var pBindDescriptorSetsInfo *_vkBindDescriptorSetsInfo
	if bindDescriptorSetsInfo != nil {
		pBindDescriptorSetsInfo = bindDescriptorSetsInfo.Vulkanize()
	}

	execTrampoline(vkCmdBindDescriptorSets2, uintptr(commandBuffer), uintptr(unsafe.Pointer(pBindDescriptorSetsInfo)))

}

var vkCmdBindDescriptorSets2 = &vkCommand{"vkCmdBindDescriptorSets2", 2, true, nil}
var CmdBindDescriptorSets2KHR = CmdBindDescriptorSets2
...
// CmdBindIndexBuffer2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBindIndexBuffer2.html
func CmdBindIndexBuffer2(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, size DeviceSize, indexType IndexType) {

	execTrampoline(vkCmdBindIndexBuffer2, uintptr(commandBuffer), uintptr(buffer), uintptr(offset), uintptr(size), uintptr(indexType))

}

var vkCmdBindIndexBuffer2 = &vkCommand{"vkCmdBindIndexBuffer2", 5, true, nil}
var CmdBindIndexBuffer2KHR = CmdBindIndexBuffer2
...
// CmdBindTileMemoryQCOM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBindTileMemoryQCOM.html
func CmdBindTileMemoryQCOM(commandBuffer CommandBuffer, tileMemoryBindInfo *TileMemoryBindInfoQCOM) {
	// Parameter is a singular input, requires translation - tileMemoryBindInfo
	var pTileMemoryBindInfo *_vkTileMemoryBindInfoQCOM
	if tileMemoryBindInfo != nil {
		pTileMemoryBindInfo = tileMemoryBindInfo.Vulkanize()
	}

	execTrampoline(vkCmdBindTileMemoryQCOM, uintptr(commandBuffer), uintptr(unsafe.Pointer(pTileMemoryBindInfo)))

}

var vkCmdBindTileMemoryQCOM = &vkCommand{"vkCmdBindTileMemoryQCOM", 2, true, nil}
...
// CmdBuildClusterAccelerationStructureIndirectNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBuildClusterAccelerationStructureIndirectNV.html
func CmdBuildClusterAccelerationStructureIndirectNV(commandBuffer CommandBuffer, commandInfos *ClusterAccelerationStructureCommandsInfoNV) {
	// Parameter is a singular input, requires translation - commandInfos
	var pCommandInfos *_vkClusterAccelerationStructureCommandsInfoNV
	if commandInfos != nil {
		pCommandInfos = commandInfos.Vulkanize()
	}

	execTrampoline(vkCmdBuildClusterAccelerationStructureIndirectNV, uintptr(commandBuffer), uintptr(unsafe.Pointer(pCommandInfos)))

}

var vkCmdBuildClusterAccelerationStructureIndirectNV = &vkCommand{"vkCmdBuildClusterAccelerationStructureIndirectNV", 2, true, nil}
...
// CmdBuildPartitionedAccelerationStructuresNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdBuildPartitionedAccelerationStructuresNV.html
func CmdBuildPartitionedAccelerationStructuresNV(commandBuffer CommandBuffer, buildInfo *BuildPartitionedAccelerationStructureInfoNV) {
	...
	var pBuildInfo *_vkBuildPartitionedAccelerationStructureInfoNV
	if buildInfo != nil {
		pBuildInfo = buildInfo.Vulkanize()
	}

	execTrampoline(vkCmdBuildPartitionedAccelerationStructuresNV, uintptr(commandBuffer), uintptr(unsafe.Pointer(pBuildInfo)))

}

var vkCmdBuildPartitionedAccelerationStructuresNV = &vkCommand{"vkCmdBuildPartitionedAccelerationStructuresNV", 2, true, nil}
...
// CmdConvertCooperativeVectorMatrixNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdConvertCooperativeVectorMatrixNV.html
func CmdConvertCooperativeVectorMatrixNV(commandBuffer CommandBuffer, infos []ConvertCooperativeVectorMatrixInfoNV) {
	infoCount := len(infos)
	// infos is an input slice that requires translation to an internal type
	var pInfos unsafe.Pointer
	if len(infos) > 0 {
		sl_infos := make([]_vkConvertCooperativeVectorMatrixInfoNV, infoCount)
		for i, v := range infos {
			sl_infos[i] = *(v.Vulkanize())
		}
		pInfos = unsafe.Pointer(&sl_infos[0])
	...
	execTrampoline(vkCmdConvertCooperativeVectorMatrixNV, uintptr(commandBuffer), uintptr(infoCount), uintptr(unsafe.Pointer(pInfos)))

}

var vkCmdConvertCooperativeVectorMatrixNV = &vkCommand{"vkCmdConvertCooperativeVectorMatrixNV", 3, true, nil}
...
// CmdCopyMemoryIndirectKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdCopyMemoryIndirectKHR.html
func CmdCopyMemoryIndirectKHR(commandBuffer CommandBuffer, copyMemoryIndirectInfo *CopyMemoryIndirectInfoKHR) {
	// Parameter is a singular input, requires translation - copyMemoryIndirectInfo
	var pCopyMemoryIndirectInfo *_vkCopyMemoryIndirectInfoKHR
	if copyMemoryIndirectInfo != nil {
		pCopyMemoryIndirectInfo = copyMemoryIndirectInfo.Vulkanize()
	}

	execTrampoline(vkCmdCopyMemoryIndirectKHR, uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyMemoryIndirectInfo)))

}

var vkCmdCopyMemoryIndirectKHR = &vkCommand{"vkCmdCopyMemoryIndirectKHR", 2, true, nil}
...
// CmdCopyMemoryToImageIndirectKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdCopyMemoryToImageIndirectKHR.html
func CmdCopyMemoryToImageIndirectKHR(commandBuffer CommandBuffer, copyMemoryToImageIndirectInfo *CopyMemoryToImageIndirectInfoKHR) {
	// Parameter is a singular input, requires translation - copyMemoryToImageIndirectInfo
	var pCopyMemoryToImageIndirectInfo *_vkCopyMemoryToImageIndirectInfoKHR
	if copyMemoryToImageIndirectInfo != nil {
		pCopyMemoryToImageIndirectInfo = copyMemoryToImageIndirectInfo.Vulkanize()
	}

	execTrampoline(vkCmdCopyMemoryToImageIndirectKHR, uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyMemoryToImageIndirectInfo)))

}

var vkCmdCopyMemoryToImageIndirectKHR = &vkCommand{"vkCmdCopyMemoryToImageIndirectKHR", 2, true, nil}
...
// CmdCopyTensorARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdCopyTensorARM.html
func CmdCopyTensorARM(commandBuffer CommandBuffer) (copyTensorInfo CopyTensorInfoARM) {
	// copyTensorInfo is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pCopyTensorInfo *_vkCopyTensorInfoARM = copyTensorInfo.Vulkanize()

	execTrampoline(vkCmdCopyTensorARM, uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyTensorInfo)))

	copyTensorInfo = *(pCopyTensorInfo.Goify())
	return
}

var vkCmdCopyTensorARM = &vkCommand{"vkCmdCopyTensorARM", 2, true, nil}
...
// CmdDispatchDataGraphARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdDispatchDataGraphARM.html
func CmdDispatchDataGraphARM(commandBuffer CommandBuffer, session DataGraphPipelineSessionARM, info *DataGraphPipelineDispatchInfoARM) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkDataGraphPipelineDispatchInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}

	execTrampoline(vkCmdDispatchDataGraphARM, uintptr(commandBuffer), uintptr(session), uintptr(unsafe.Pointer(pInfo)))

}

var vkCmdDispatchDataGraphARM = &vkCommand{"vkCmdDispatchDataGraphARM", 3, true, nil}
...
// CmdDispatchTileQCOM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdDispatchTileQCOM.html
func CmdDispatchTileQCOM(commandBuffer CommandBuffer, dispatchTileInfo *DispatchTileInfoQCOM) {
	// Parameter is a singular input, requires translation - dispatchTileInfo
	var pDispatchTileInfo *_vkDispatchTileInfoQCOM
	if dispatchTileInfo != nil {
		pDispatchTileInfo = dispatchTileInfo.Vulkanize()
	}

	execTrampoline(vkCmdDispatchTileQCOM, uintptr(commandBuffer), uintptr(unsafe.Pointer(pDispatchTileInfo)))

}

var vkCmdDispatchTileQCOM = &vkCommand{"vkCmdDispatchTileQCOM", 2, true, nil}
...
// CmdEndPerTileExecutionQCOM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdEndPerTileExecutionQCOM.html
func CmdEndPerTileExecutionQCOM(commandBuffer CommandBuffer, perTileEndInfo *PerTileEndInfoQCOM) {
	// Parameter is a singular input, requires translation - perTileEndInfo
	var pPerTileEndInfo *_vkPerTileEndInfoQCOM
	if perTileEndInfo != nil {
		pPerTileEndInfo = perTileEndInfo.Vulkanize()
	}

	execTrampoline(vkCmdEndPerTileExecutionQCOM, uintptr(commandBuffer), uintptr(unsafe.Pointer(pPerTileEndInfo)))

}

var vkCmdEndPerTileExecutionQCOM = &vkCommand{"vkCmdEndPerTileExecutionQCOM", 2, true, nil}
...
// CmdEndRendering2EXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdEndRendering2EXT.html
func CmdEndRendering2EXT(commandBuffer CommandBuffer, renderingEndInfo *RenderingEndInfoEXT) {
	// Parameter is a singular input, requires translation - renderingEndInfo
	var pRenderingEndInfo *_vkRenderingEndInfoEXT
	if renderingEndInfo != nil {
		pRenderingEndInfo = renderingEndInfo.Vulkanize()
	}

	execTrampoline(vkCmdEndRendering2EXT, uintptr(commandBuffer), uintptr(unsafe.Pointer(pRenderingEndInfo)))

}

var vkCmdEndRendering2EXT = &vkCommand{"vkCmdEndRendering2EXT", 2, true, nil}
...
// CmdExecuteGeneratedCommandsEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdExecuteGeneratedCommandsEXT.html
func CmdExecuteGeneratedCommandsEXT(commandBuffer CommandBuffer, isPreprocessed bool, generatedCommandsInfo *GeneratedCommandsInfoEXT) {
	...
	var pGeneratedCommandsInfo *_vkGeneratedCommandsInfoEXT
	if generatedCommandsInfo != nil {
		pGeneratedCommandsInfo = generatedCommandsInfo.Vulkanize()
	}

	execTrampoline(vkCmdExecuteGeneratedCommandsEXT, uintptr(commandBuffer), uintptr(isPreprocessed_Bool32), uintptr(unsafe.Pointer(pGeneratedCommandsInfo)))

}

var vkCmdExecuteGeneratedCommandsEXT = &vkCommand{"vkCmdExecuteGeneratedCommandsEXT", 3, true, nil}
...
// CmdPreprocessGeneratedCommandsEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPreprocessGeneratedCommandsEXT.html
func CmdPreprocessGeneratedCommandsEXT(commandBuffer CommandBuffer, generatedCommandsInfo *GeneratedCommandsInfoEXT, stateCommandBuffer CommandBuffer) {
	...
	execTrampoline(vkCmdPreprocessGeneratedCommandsEXT, uintptr(commandBuffer), uintptr(unsafe.Pointer(pGeneratedCommandsInfo)), uintptr(stateCommandBuffer))

}

var vkCmdPreprocessGeneratedCommandsEXT = &vkCommand{"vkCmdPreprocessGeneratedCommandsEXT", 3, true, nil}
...
// CmdPushConstants2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPushConstants2.html
func CmdPushConstants2(commandBuffer CommandBuffer, pushConstantsInfo *PushConstantsInfo) {
	...
	var pPushConstantsInfo *_vkPushConstantsInfo
	if pushConstantsInfo != nil {
		pPushConstantsInfo = pushConstantsInfo.Vulkanize()
	}

	execTrampoline(vkCmdPushConstants2, uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushConstantsInfo)))

}

var vkCmdPushConstants2 = &vkCommand{"vkCmdPushConstants2", 2, true, nil}
var CmdPushConstants2KHR = CmdPushConstants2

// CmdPushDescriptorSet: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPushDescriptorSet.html
func CmdPushDescriptorSet(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, set uint32, descriptorWrites []WriteDescriptorSet) {
	...
	execTrampoline(vkCmdPushDescriptorSet, uintptr(commandBuffer), uintptr(pipelineBindPoint), uintptr(layout), uintptr(set), uintptr(descriptorWriteCount), uintptr(unsafe.Pointer(pDescriptorWrites)))

}

var vkCmdPushDescriptorSet = &vkCommand{"vkCmdPushDescriptorSet", 6, true, nil}

// CmdPushDescriptorSet2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPushDescriptorSet2.html
func CmdPushDescriptorSet2(commandBuffer CommandBuffer, pushDescriptorSetInfo *PushDescriptorSetInfo) {
	...
	var pPushDescriptorSetInfo *_vkPushDescriptorSetInfo
	if pushDescriptorSetInfo != nil {
		pPushDescriptorSetInfo = pushDescriptorSetInfo.Vulkanize()
	}

	execTrampoline(vkCmdPushDescriptorSet2, uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushDescriptorSetInfo)))

}

var vkCmdPushDescriptorSet2 = &vkCommand{"vkCmdPushDescriptorSet2", 2, true, nil}
var CmdPushDescriptorSet2KHR = CmdPushDescriptorSet2

var CmdPushDescriptorSetKHR = CmdPushDescriptorSet

// CmdPushDescriptorSetWithTemplate: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPushDescriptorSetWithTemplate.html
func CmdPushDescriptorSetWithTemplate(commandBuffer CommandBuffer, descriptorUpdateTemplate DescriptorUpdateTemplate, layout PipelineLayout, set uint32, data *byte) {
	...
	execTrampoline(vkCmdPushDescriptorSetWithTemplate, uintptr(commandBuffer), uintptr(descriptorUpdateTemplate), uintptr(layout), uintptr(set), uintptr(unsafe.Pointer(pData)))

}

var vkCmdPushDescriptorSetWithTemplate = &vkCommand{"vkCmdPushDescriptorSetWithTemplate", 5, true, nil}

// CmdPushDescriptorSetWithTemplate2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdPushDescriptorSetWithTemplate2.html
func CmdPushDescriptorSetWithTemplate2(commandBuffer CommandBuffer, pushDescriptorSetWithTemplateInfo *PushDescriptorSetWithTemplateInfo) {
	...
	var pPushDescriptorSetWithTemplateInfo *_vkPushDescriptorSetWithTemplateInfo
	if pushDescriptorSetWithTemplateInfo != nil {
		pPushDescriptorSetWithTemplateInfo = pushDescriptorSetWithTemplateInfo.Vulkanize()
	}

	execTrampoline(vkCmdPushDescriptorSetWithTemplate2, uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushDescriptorSetWithTemplateInfo)))

}

var vkCmdPushDescriptorSetWithTemplate2 = &vkCommand{"vkCmdPushDescriptorSetWithTemplate2", 2, true, nil}
var CmdPushDescriptorSetWithTemplate2KHR = CmdPushDescriptorSetWithTemplate2

var CmdPushDescriptorSetWithTemplateKHR = CmdPushDescriptorSetWithTemplate
...
// CmdSetDepthClampRangeEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdSetDepthClampRangeEXT.html
func CmdSetDepthClampRangeEXT(commandBuffer CommandBuffer, depthClampMode DepthClampModeEXT, depthClampRange *DepthClampRangeEXT) {
	// Parameter is a singular input, pass direct - depthClampRange
	var pDepthClampRange unsafe.Pointer
	if depthClampRange != nil {
		pDepthClampRange = unsafe.Pointer(depthClampRange)
	}

	execTrampoline(vkCmdSetDepthClampRangeEXT, uintptr(commandBuffer), uintptr(depthClampMode), uintptr(unsafe.Pointer(pDepthClampRange)))

}

var vkCmdSetDepthClampRangeEXT = &vkCommand{"vkCmdSetDepthClampRangeEXT", 3, true, nil}
...
// CmdSetLineStipple: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdSetLineStipple.html
func CmdSetLineStipple(commandBuffer CommandBuffer, lineStippleFactor uint32, lineStipplePattern uint16) {

	execTrampoline(vkCmdSetLineStipple, uintptr(commandBuffer), uintptr(lineStippleFactor), uintptr(lineStipplePattern))

}

var vkCmdSetLineStipple = &vkCommand{"vkCmdSetLineStipple", 3, true, nil}
var CmdSetLineStippleEXT = CmdSetLineStipple
...
var CmdSetLineStippleKHR = CmdSetLineStipple
...
// CmdSetRenderingAttachmentLocations: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdSetRenderingAttachmentLocations.html
func CmdSetRenderingAttachmentLocations(commandBuffer CommandBuffer, locationInfo *RenderingAttachmentLocationInfo) {
	// Parameter is a singular input, requires translation - locationInfo
	var pLocationInfo *_vkRenderingAttachmentLocationInfo
	if locationInfo != nil {
		pLocationInfo = locationInfo.Vulkanize()
	}

	execTrampoline(vkCmdSetRenderingAttachmentLocations, uintptr(commandBuffer), uintptr(unsafe.Pointer(pLocationInfo)))

}

var vkCmdSetRenderingAttachmentLocations = &vkCommand{"vkCmdSetRenderingAttachmentLocations", 2, true, nil}
var CmdSetRenderingAttachmentLocationsKHR = CmdSetRenderingAttachmentLocations

// CmdSetRenderingInputAttachmentIndices: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCmdSetRenderingInputAttachmentIndices.html
func CmdSetRenderingInputAttachmentIndices(commandBuffer CommandBuffer, inputAttachmentIndexInfo *RenderingInputAttachmentIndexInfo) {
	// Parameter is a singular input, requires translation - inputAttachmentIndexInfo
	var pInputAttachmentIndexInfo *_vkRenderingInputAttachmentIndexInfo
	if inputAttachmentIndexInfo != nil {
		pInputAttachmentIndexInfo = inputAttachmentIndexInfo.Vulkanize()
	}

	execTrampoline(vkCmdSetRenderingInputAttachmentIndices, uintptr(commandBuffer), uintptr(unsafe.Pointer(pInputAttachmentIndexInfo)))

}

var vkCmdSetRenderingInputAttachmentIndices = &vkCommand{"vkCmdSetRenderingInputAttachmentIndices", 2, true, nil}
var CmdSetRenderingInputAttachmentIndicesKHR = CmdSetRenderingInputAttachmentIndices
...
// ConvertCooperativeVectorMatrixNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkConvertCooperativeVectorMatrixNV.html
func ConvertCooperativeVectorMatrixNV(device Device, info *ConvertCooperativeVectorMatrixInfoNV) (r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkConvertCooperativeVectorMatrixInfoNV
	if info != nil {
		pInfo = info.Vulkanize()
	}

	r = Result(execTrampoline(vkConvertCooperativeVectorMatrixNV, uintptr(device), uintptr(unsafe.Pointer(pInfo))))
...
var vkConvertCooperativeVectorMatrixNV = &vkCommand{"vkConvertCooperativeVectorMatrixNV", 2, true, nil}
...
// CopyImageToImage: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCopyImageToImage.html
func CopyImageToImage(device Device, copyImageToImageInfo *CopyImageToImageInfo) (r error) {
	// Parameter is a singular input, requires translation - copyImageToImageInfo
	var pCopyImageToImageInfo *_vkCopyImageToImageInfo
	if copyImageToImageInfo != nil {
		pCopyImageToImageInfo = copyImageToImageInfo.Vulkanize()
	}

	r = Result(execTrampoline(vkCopyImageToImage, uintptr(device), uintptr(unsafe.Pointer(pCopyImageToImageInfo))))
...
var vkCopyImageToImage = &vkCommand{"vkCopyImageToImage", 2, true, nil}
var CopyImageToImageEXT = CopyImageToImage

// CopyImageToMemory: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCopyImageToMemory.html
func CopyImageToMemory(device Device, copyImageToMemoryInfo *CopyImageToMemoryInfo) (r error) {
	// Parameter is a singular input, requires translation - copyImageToMemoryInfo
	var pCopyImageToMemoryInfo *_vkCopyImageToMemoryInfo
	if copyImageToMemoryInfo != nil {
		pCopyImageToMemoryInfo = copyImageToMemoryInfo.Vulkanize()
	}

	r = Result(execTrampoline(vkCopyImageToMemory, uintptr(device), uintptr(unsafe.Pointer(pCopyImageToMemoryInfo))))
...
var vkCopyImageToMemory = &vkCommand{"vkCopyImageToMemory", 2, true, nil}
var CopyImageToMemoryEXT = CopyImageToMemory
...
// CopyMemoryToImage: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCopyMemoryToImage.html
func CopyMemoryToImage(device Device, copyMemoryToImageInfo *CopyMemoryToImageInfo) (r error) {
	// Parameter is a singular input, requires translation - copyMemoryToImageInfo
	var pCopyMemoryToImageInfo *_vkCopyMemoryToImageInfo
	if copyMemoryToImageInfo != nil {
		pCopyMemoryToImageInfo = copyMemoryToImageInfo.Vulkanize()
	}

	r = Result(execTrampoline(vkCopyMemoryToImage, uintptr(device), uintptr(unsafe.Pointer(pCopyMemoryToImageInfo))))
...
var vkCopyMemoryToImage = &vkCommand{"vkCopyMemoryToImage", 2, true, nil}
var CopyMemoryToImageEXT = CopyMemoryToImage
...
// CreateDataGraphPipelineSessionARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateDataGraphPipelineSessionARM.html
func CreateDataGraphPipelineSessionARM(device Device, createInfo *DataGraphPipelineSessionCreateInfoARM, allocator *AllocationCallbacks) (session DataGraphPipelineSessionARM, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkDataGraphPipelineSessionCreateInfoARM
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkCreateDataGraphPipelineSessionARM, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pSession))))
...
var vkCreateDataGraphPipelineSessionARM = &vkCommand{"vkCreateDataGraphPipelineSessionARM", 4, true, nil}

// CreateDataGraphPipelinesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateDataGraphPipelinesARM.html
func CreateDataGraphPipelinesARM(device Device, deferredOperation DeferredOperationKHR, pipelineCache PipelineCache, createInfos []DataGraphPipelineCreateInfoARM, allocator *AllocationCallbacks) (pipelines []Pipeline, r error) {
	createInfoCount := len(createInfos)
	// createInfos is an input slice that requires translation to an internal type
	var pCreateInfos unsafe.Pointer
	if len(createInfos) > 0 {
		sl_createInfos := make([]_vkDataGraphPipelineCreateInfoARM, createInfoCount)
		for i, v := range createInfos {
			sl_createInfos[i] = *(v.Vulkanize())
		}
		pCreateInfos = unsafe.Pointer(&sl_createInfos[0])
	...
	r = Result(execTrampoline(vkCreateDataGraphPipelinesARM, uintptr(device), uintptr(deferredOperation), uintptr(pipelineCache), uintptr(createInfoCount), uintptr(unsafe.Pointer(pCreateInfos)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(pPipelines))))
...
var vkCreateDataGraphPipelinesARM = &vkCommand{"vkCreateDataGraphPipelinesARM", 7, true, nil}
...
// CreateExternalComputeQueueNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateExternalComputeQueueNV.html
func CreateExternalComputeQueueNV(device Device, createInfo *ExternalComputeQueueCreateInfoNV, allocator *AllocationCallbacks) (externalQueue ExternalComputeQueueNV, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkExternalComputeQueueCreateInfoNV
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	// externalQueue is a binding-allocated single return value and will be populated by Vulkan
	ptr_pExternalQueue := &externalQueue

	r = Result(execTrampoline(vkCreateExternalComputeQueueNV, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pExternalQueue))))
...
var vkCreateExternalComputeQueueNV = &vkCommand{"vkCreateExternalComputeQueueNV", 4, true, nil}
...
// CreateIndirectCommandsLayoutEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateIndirectCommandsLayoutEXT.html
func CreateIndirectCommandsLayoutEXT(device Device, createInfo *IndirectCommandsLayoutCreateInfoEXT, allocator *AllocationCallbacks) (indirectCommandsLayout IndirectCommandsLayoutEXT, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkIndirectCommandsLayoutCreateInfoEXT
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkCreateIndirectCommandsLayoutEXT, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pIndirectCommandsLayout))))
...
var vkCreateIndirectCommandsLayoutEXT = &vkCommand{"vkCreateIndirectCommandsLayoutEXT", 4, true, nil}
...
// CreateIndirectExecutionSetEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateIndirectExecutionSetEXT.html
func CreateIndirectExecutionSetEXT(device Device, createInfo *IndirectExecutionSetCreateInfoEXT, allocator *AllocationCallbacks) (indirectExecutionSet IndirectExecutionSetEXT, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkIndirectExecutionSetCreateInfoEXT
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	// indirectExecutionSet is a binding-allocated single return value and will be populated by Vulkan
	ptr_pIndirectExecutionSet := &indirectExecutionSet

	r = Result(execTrampoline(vkCreateIndirectExecutionSetEXT, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pIndirectExecutionSet))))
...
var vkCreateIndirectExecutionSetEXT = &vkCommand{"vkCreateIndirectExecutionSetEXT", 4, true, nil}
...
// CreatePipelineBinariesKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreatePipelineBinariesKHR.html
func CreatePipelineBinariesKHR(device Device, createInfo *PipelineBinaryCreateInfoKHR, allocator *AllocationCallbacks) (binaries PipelineBinaryHandlesInfoKHR, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkPipelineBinaryCreateInfoKHR
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	// binaries is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pBinaries *_vkPipelineBinaryHandlesInfoKHR = binaries.Vulkanize()

	r = Result(execTrampoline(vkCreatePipelineBinariesKHR, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(pBinaries))))

	binaries = *(pBinaries.Goify())
	if r == Result(0) {
		r = SUCCESS
	}
	return
...
var vkCreatePipelineBinariesKHR = &vkCommand{"vkCreatePipelineBinariesKHR", 4, true, nil}
...
// CreateTensorARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateTensorARM.html
func CreateTensorARM(device Device, createInfo *TensorCreateInfoARM, allocator *AllocationCallbacks) (tensor TensorARM, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkTensorCreateInfoARM
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	// tensor is a binding-allocated single return value and will be populated by Vulkan
	ptr_pTensor := &tensor

	r = Result(execTrampoline(vkCreateTensorARM, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pTensor))))
...
var vkCreateTensorARM = &vkCommand{"vkCreateTensorARM", 4, true, nil}

// CreateTensorViewARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateTensorViewARM.html
func CreateTensorViewARM(device Device, createInfo *TensorViewCreateInfoARM, allocator *AllocationCallbacks) (view TensorViewARM, r error) {
	// Parameter is a singular input, requires translation - createInfo
	var pCreateInfo *_vkTensorViewCreateInfoARM
	if createInfo != nil {
		pCreateInfo = createInfo.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkCreateTensorViewARM, uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_pView))))
...
var vkCreateTensorViewARM = &vkCommand{"vkCreateTensorViewARM", 4, true, nil}
...
// DestroyDataGraphPipelineSessionARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyDataGraphPipelineSessionARM.html
func DestroyDataGraphPipelineSessionARM(device Device, session DataGraphPipelineSessionARM, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyDataGraphPipelineSessionARM, uintptr(device), uintptr(session), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyDataGraphPipelineSessionARM = &vkCommand{"vkDestroyDataGraphPipelineSessionARM", 3, true, nil}
...
// DestroyExternalComputeQueueNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyExternalComputeQueueNV.html
func DestroyExternalComputeQueueNV(device Device, externalQueue ExternalComputeQueueNV, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyExternalComputeQueueNV, uintptr(device), uintptr(externalQueue), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyExternalComputeQueueNV = &vkCommand{"vkDestroyExternalComputeQueueNV", 3, true, nil}
...
// DestroyIndirectCommandsLayoutEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyIndirectCommandsLayoutEXT.html
func DestroyIndirectCommandsLayoutEXT(device Device, indirectCommandsLayout IndirectCommandsLayoutEXT, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyIndirectCommandsLayoutEXT, uintptr(device), uintptr(indirectCommandsLayout), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyIndirectCommandsLayoutEXT = &vkCommand{"vkDestroyIndirectCommandsLayoutEXT", 3, true, nil}
...
// DestroyIndirectExecutionSetEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyIndirectExecutionSetEXT.html
func DestroyIndirectExecutionSetEXT(device Device, indirectExecutionSet IndirectExecutionSetEXT, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyIndirectExecutionSetEXT, uintptr(device), uintptr(indirectExecutionSet), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyIndirectExecutionSetEXT = &vkCommand{"vkDestroyIndirectExecutionSetEXT", 3, true, nil}
...
// DestroyPipelineBinaryKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyPipelineBinaryKHR.html
func DestroyPipelineBinaryKHR(device Device, pipelineBinary PipelineBinaryKHR, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyPipelineBinaryKHR, uintptr(device), uintptr(pipelineBinary), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyPipelineBinaryKHR = &vkCommand{"vkDestroyPipelineBinaryKHR", 3, true, nil}
...
// DestroyTensorARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyTensorARM.html
func DestroyTensorARM(device Device, tensor TensorARM, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyTensorARM, uintptr(device), uintptr(tensor), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyTensorARM = &vkCommand{"vkDestroyTensorARM", 3, true, nil}

// DestroyTensorViewARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkDestroyTensorViewARM.html
func DestroyTensorViewARM(device Device, tensorView TensorViewARM, allocator *AllocationCallbacks) {
	...
	execTrampoline(vkDestroyTensorViewARM, uintptr(device), uintptr(tensorView), uintptr(unsafe.Pointer(pAllocator)))

}

var vkDestroyTensorViewARM = &vkCommand{"vkDestroyTensorViewARM", 3, true, nil}
...
// GetClusterAccelerationStructureBuildSizesNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetClusterAccelerationStructureBuildSizesNV.html
func GetClusterAccelerationStructureBuildSizesNV(device Device, info *ClusterAccelerationStructureInputInfoNV) (sizeInfo AccelerationStructureBuildSizesInfoKHR) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkClusterAccelerationStructureInputInfoNV
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetClusterAccelerationStructureBuildSizesNV, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pSizeInfo)))

	sizeInfo = *(pSizeInfo.Goify())
	return
}

var vkGetClusterAccelerationStructureBuildSizesNV = &vkCommand{"vkGetClusterAccelerationStructureBuildSizesNV", 3, true, nil}

// GetDataGraphPipelineAvailablePropertiesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDataGraphPipelineAvailablePropertiesARM.html
func GetDataGraphPipelineAvailablePropertiesARM(device Device, pipelineInfo *DataGraphPipelineInfoARM) (properties []DataGraphPipelinePropertyARM, r error) {
	// Parameter is a singular input, requires translation - pipelineInfo
	var pPipelineInfo *_vkDataGraphPipelineInfoARM
	if pipelineInfo != nil {
	...
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pProperties *DataGraphPipelinePropertyARM

	r = Result(execTrampoline(vkGetDataGraphPipelineAvailablePropertiesARM, uintptr(device), uintptr(unsafe.Pointer(pPipelineInfo)), uintptr(unsafe.Pointer(pPropertiesCount)), uintptr(unsafe.Pointer(pProperties))))

	sl_pProperties := make([]DataGraphPipelinePropertyARM, propertiesCount)
	properties = make([]DataGraphPipelinePropertyARM, propertiesCount)
	pProperties = &sl_pProperties[0]
...
var vkGetDataGraphPipelineAvailablePropertiesARM = &vkCommand{"vkGetDataGraphPipelineAvailablePropertiesARM", 4, true, nil}

// GetDataGraphPipelinePropertiesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDataGraphPipelinePropertiesARM.html
func GetDataGraphPipelinePropertiesARM(device Device, pipelineInfo *DataGraphPipelineInfoARM, properties []DataGraphPipelinePropertyQueryResultARM) (r error) {
	// Parameter is a singular input, requires translation - pipelineInfo
	var pPipelineInfo *_vkDataGraphPipelineInfoARM
	if pipelineInfo != nil {
		pPipelineInfo = pipelineInfo.Vulkanize()
	...
	// properties is a user-allocated array input that will be written to
	pProperties := unsafe.Pointer(&properties[0])

	r = Result(execTrampoline(vkGetDataGraphPipelinePropertiesARM, uintptr(device), uintptr(unsafe.Pointer(pPipelineInfo)), uintptr(propertiesCount), uintptr(unsafe.Pointer(pProperties))))
...
var vkGetDataGraphPipelinePropertiesARM = &vkCommand{"vkGetDataGraphPipelinePropertiesARM", 4, true, nil}

// GetDataGraphPipelineSessionBindPointRequirementsARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDataGraphPipelineSessionBindPointRequirementsARM.html
func GetDataGraphPipelineSessionBindPointRequirementsARM(device Device, info *DataGraphPipelineSessionBindPointRequirementsInfoARM) (bindPointRequirements []DataGraphPipelineSessionBindPointRequirementARM, r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkDataGraphPipelineSessionBindPointRequirementsInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}

	// bindPointRequirements is a double-call array output
	var bindPointRequirementCount uint32
	pBindPointRequirementCount := &bindPointRequirementCount
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pBindPointRequirements *_vkDataGraphPipelineSessionBindPointRequirementARM

	r = Result(execTrampoline(vkGetDataGraphPipelineSessionBindPointRequirementsARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pBindPointRequirementCount)), uintptr(unsafe.Pointer(pBindPointRequirements))))

	sl_pBindPointRequirements := make([]_vkDataGraphPipelineSessionBindPointRequirementARM, bindPointRequirementCount)
	bindPointRequirements = make([]DataGraphPipelineSessionBindPointRequirementARM, bindPointRequirementCount)
	pBindPointRequirements = &sl_pBindPointRequirements[0]

	// Trampoline call after last array allocation
	r = Result(execTrampoline(vkGetDataGraphPipelineSessionBindPointRequirementsARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pBindPointRequirementCount)), uintptr(unsafe.Pointer(pBindPointRequirements))))

	for i := range sl_pBindPointRequirements {
		bindPointRequirements[i] = *sl_pBindPointRequirements[i].Goify()
	}
	if r == Result(0) {
		r = SUCCESS
	}
...
var vkGetDataGraphPipelineSessionBindPointRequirementsARM = &vkCommand{"vkGetDataGraphPipelineSessionBindPointRequirementsARM", 4, true, nil}

// GetDataGraphPipelineSessionMemoryRequirementsARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDataGraphPipelineSessionMemoryRequirementsARM.html
func GetDataGraphPipelineSessionMemoryRequirementsARM(device Device, info *DataGraphPipelineSessionMemoryRequirementsInfoARM) (memoryRequirements MemoryRequirements2) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkDataGraphPipelineSessionMemoryRequirementsInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetDataGraphPipelineSessionMemoryRequirementsARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))

	memoryRequirements = *(pMemoryRequirements.Goify())
	return
}

var vkGetDataGraphPipelineSessionMemoryRequirementsARM = &vkCommand{"vkGetDataGraphPipelineSessionMemoryRequirementsARM", 3, true, nil}
...
// GetDeviceImageSubresourceLayout: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDeviceImageSubresourceLayout.html
func GetDeviceImageSubresourceLayout(device Device, info *DeviceImageSubresourceInfo) (layout SubresourceLayout2) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkDeviceImageSubresourceInfo
	if info != nil {
		pInfo = info.Vulkanize()
	}

	// layout is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pLayout *_vkSubresourceLayout2 = layout.Vulkanize()

	execTrampoline(vkGetDeviceImageSubresourceLayout, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pLayout)))

	layout = *(pLayout.Goify())
	return
}

var vkGetDeviceImageSubresourceLayout = &vkCommand{"vkGetDeviceImageSubresourceLayout", 3, true, nil}
var GetDeviceImageSubresourceLayoutKHR = GetDeviceImageSubresourceLayout
...
// GetDeviceTensorMemoryRequirementsARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDeviceTensorMemoryRequirementsARM.html
func GetDeviceTensorMemoryRequirementsARM(device Device, info *DeviceTensorMemoryRequirementsARM) (memoryRequirements MemoryRequirements2) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkDeviceTensorMemoryRequirementsARM
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetDeviceTensorMemoryRequirementsARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))

	memoryRequirements = *(pMemoryRequirements.Goify())
	return
}

var vkGetDeviceTensorMemoryRequirementsARM = &vkCommand{"vkGetDeviceTensorMemoryRequirementsARM", 3, true, nil}
...
// GetExternalComputeQueueDataNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetExternalComputeQueueDataNV.html
func GetExternalComputeQueueDataNV(externalQueue ExternalComputeQueueNV) (arams ExternalComputeQueueDataParamsNV, data byte) {
	// arams is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var params *_vkExternalComputeQueueDataParamsNV = arams.Vulkanize()

	// data is a binding-allocated single return value and will be populated by Vulkan
	ptr_pData := &data

	execTrampoline(vkGetExternalComputeQueueDataNV, uintptr(externalQueue), uintptr(unsafe.Pointer(params)), uintptr(unsafe.Pointer(ptr_pData)))

	arams = *(params.Goify())
	return
}

var vkGetExternalComputeQueueDataNV = &vkCommand{"vkGetExternalComputeQueueDataNV", 3, true, nil}
...
// GetGeneratedCommandsMemoryRequirementsEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetGeneratedCommandsMemoryRequirementsEXT.html
func GetGeneratedCommandsMemoryRequirementsEXT(device Device, info *GeneratedCommandsMemoryRequirementsInfoEXT) (memoryRequirements MemoryRequirements2) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkGeneratedCommandsMemoryRequirementsInfoEXT
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetGeneratedCommandsMemoryRequirementsEXT, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))

	memoryRequirements = *(pMemoryRequirements.Goify())
	return
}

var vkGetGeneratedCommandsMemoryRequirementsEXT = &vkCommand{"vkGetGeneratedCommandsMemoryRequirementsEXT", 3, true, nil}
...
// GetImageSubresourceLayout2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetImageSubresourceLayout2.html
func GetImageSubresourceLayout2(device Device, image Image, subresource *ImageSubresource2) (layout SubresourceLayout2) {
	...
	var pSubresource *_vkImageSubresource2
	if subresource != nil {
	...
	execTrampoline(vkGetImageSubresourceLayout2, uintptr(device), uintptr(image), uintptr(unsafe.Pointer(pSubresource)), uintptr(unsafe.Pointer(pLayout)))

	layout = *(pLayout.Goify())
	return
}

var vkGetImageSubresourceLayout2 = &vkCommand{"vkGetImageSubresourceLayout2", 4, true, nil}
var GetImageSubresourceLayout2EXT = GetImageSubresourceLayout2

var GetImageSubresourceLayout2KHR = GetImageSubresourceLayout2
...
// GetImageViewHandle64NVX: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetImageViewHandle64NVX.html
func GetImageViewHandle64NVX(device Device, info *ImageViewHandleInfoNVX) (r uint64) {
	// Parameter is a singular input, requires translation - info
	...
	r = uint64(execTrampoline(vkGetImageViewHandle64NVX, uintptr(device), uintptr(unsafe.Pointer(pInfo))))

	return
}

var vkGetImageViewHandle64NVX = &vkCommand{"vkGetImageViewHandle64NVX", 2, true, nil}
...
// GetPartitionedAccelerationStructuresBuildSizesNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPartitionedAccelerationStructuresBuildSizesNV.html
func GetPartitionedAccelerationStructuresBuildSizesNV(device Device, info *PartitionedAccelerationStructureInstancesInputNV) (sizeInfo AccelerationStructureBuildSizesInfoKHR) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkPartitionedAccelerationStructureInstancesInputNV
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetPartitionedAccelerationStructuresBuildSizesNV, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pSizeInfo)))

	sizeInfo = *(pSizeInfo.Goify())
	return
}

var vkGetPartitionedAccelerationStructuresBuildSizesNV = &vkCommand{"vkGetPartitionedAccelerationStructuresBuildSizesNV", 3, true, nil}
...
// GetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV.html
func GetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV(physicalDevice PhysicalDevice) (properties []CooperativeMatrixFlexibleDimensionsPropertiesNV, r error) {
	// properties is a double-call array output
	var propertyCount uint32
	pPropertyCount := &propertyCount
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pProperties *_vkCooperativeMatrixFlexibleDimensionsPropertiesNV

	r = Result(execTrampoline(vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV, uintptr(physicalDevice), uintptr(unsafe.Pointer(pPropertyCount)), uintptr(unsafe.Pointer(pProperties))))

	sl_pProperties := make([]_vkCooperativeMatrixFlexibleDimensionsPropertiesNV, propertyCount)
	properties = make([]CooperativeMatrixFlexibleDimensionsPropertiesNV, propertyCount)
	pProperties = &sl_pProperties[0]
...
var vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV = &vkCommand{"vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV", 3, true, nil}
...
// GetPhysicalDeviceCooperativeVectorPropertiesNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceCooperativeVectorPropertiesNV.html
func GetPhysicalDeviceCooperativeVectorPropertiesNV(physicalDevice PhysicalDevice) (properties []CooperativeVectorPropertiesNV, r error) {
	// properties is a double-call array output
	var propertyCount uint32
	pPropertyCount := &propertyCount
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pProperties *_vkCooperativeVectorPropertiesNV

	r = Result(execTrampoline(vkGetPhysicalDeviceCooperativeVectorPropertiesNV, uintptr(physicalDevice), uintptr(unsafe.Pointer(pPropertyCount)), uintptr(unsafe.Pointer(pProperties))))

	sl_pProperties := make([]_vkCooperativeVectorPropertiesNV, propertyCount)
	properties = make([]CooperativeVectorPropertiesNV, propertyCount)
	pProperties = &sl_pProperties[0]
...
var vkGetPhysicalDeviceCooperativeVectorPropertiesNV = &vkCommand{"vkGetPhysicalDeviceCooperativeVectorPropertiesNV", 3, true, nil}
...
// GetPhysicalDeviceExternalTensorPropertiesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceExternalTensorPropertiesARM.html
func GetPhysicalDeviceExternalTensorPropertiesARM(physicalDevice PhysicalDevice, externalTensorInfo *PhysicalDeviceExternalTensorInfoARM) (externalTensorProperties ExternalTensorPropertiesARM) {
	// Parameter is a singular input, requires translation - externalTensorInfo
	var pExternalTensorInfo *_vkPhysicalDeviceExternalTensorInfoARM
	if externalTensorInfo != nil {
		pExternalTensorInfo = externalTensorInfo.Vulkanize()
	}

	// externalTensorProperties is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pExternalTensorProperties *_vkExternalTensorPropertiesARM = externalTensorProperties.Vulkanize()

	execTrampoline(vkGetPhysicalDeviceExternalTensorPropertiesARM, uintptr(physicalDevice), uintptr(unsafe.Pointer(pExternalTensorInfo)), uintptr(unsafe.Pointer(pExternalTensorProperties)))

	externalTensorProperties = *(pExternalTensorProperties.Goify())
	return
}

var vkGetPhysicalDeviceExternalTensorPropertiesARM = &vkCommand{"vkGetPhysicalDeviceExternalTensorPropertiesARM", 3, true, nil}
...
// GetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM.html
func GetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM(physicalDevice PhysicalDevice, queueFamilyDataGraphProcessingEngineInfo *PhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM) (queueFamilyDataGraphProcessingEngineProperties QueueFamilyDataGraphProcessingEnginePropertiesARM) {
	// Parameter is a singular input, requires translation - queueFamilyDataGraphProcessingEngineInfo
	var pQueueFamilyDataGraphProcessingEngineInfo *_vkPhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM
	if queueFamilyDataGraphProcessingEngineInfo != nil {
		pQueueFamilyDataGraphProcessingEngineInfo = queueFamilyDataGraphProcessingEngineInfo.Vulkanize()
	}

	// queueFamilyDataGraphProcessingEngineProperties is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pQueueFamilyDataGraphProcessingEngineProperties *_vkQueueFamilyDataGraphProcessingEnginePropertiesARM = queueFamilyDataGraphProcessingEngineProperties.Vulkanize()

	execTrampoline(vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM, uintptr(physicalDevice), uintptr(unsafe.Pointer(pQueueFamilyDataGraphProcessingEngineInfo)), uintptr(unsafe.Pointer(pQueueFamilyDataGraphProcessingEngineProperties)))

	queueFamilyDataGraphProcessingEngineProperties = *(pQueueFamilyDataGraphProcessingEngineProperties.Goify())
	return
}

var vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM = &vkCommand{"vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM", 3, true, nil}

// GetPhysicalDeviceQueueFamilyDataGraphPropertiesARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM.html
func GetPhysicalDeviceQueueFamilyDataGraphPropertiesARM(physicalDevice PhysicalDevice, queueFamilyIndex uint32) (queueFamilyDataGraphProperties []QueueFamilyDataGraphPropertiesARM, r error) {
	// queueFamilyDataGraphProperties is a double-call array output
	var queueFamilyDataGraphPropertyCount uint32
	pQueueFamilyDataGraphPropertyCount := &queueFamilyDataGraphPropertyCount
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pQueueFamilyDataGraphProperties *_vkQueueFamilyDataGraphPropertiesARM

	r = Result(execTrampoline(vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM, uintptr(physicalDevice), uintptr(queueFamilyIndex), uintptr(unsafe.Pointer(pQueueFamilyDataGraphPropertyCount)), uintptr(unsafe.Pointer(pQueueFamilyDataGraphProperties))))

	sl_pQueueFamilyDataGraphProperties := make([]_vkQueueFamilyDataGraphPropertiesARM, queueFamilyDataGraphPropertyCount)
	queueFamilyDataGraphProperties = make([]QueueFamilyDataGraphPropertiesARM, queueFamilyDataGraphPropertyCount)
	pQueueFamilyDataGraphProperties = &sl_pQueueFamilyDataGraphProperties[0]

	// Trampoline call after last array allocation
	r = Result(execTrampoline(vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM, uintptr(physicalDevice), uintptr(queueFamilyIndex), uintptr(unsafe.Pointer(pQueueFamilyDataGraphPropertyCount)), uintptr(unsafe.Pointer(pQueueFamilyDataGraphProperties))))

	for i := range sl_pQueueFamilyDataGraphProperties {
		queueFamilyDataGraphProperties[i] = *sl_pQueueFamilyDataGraphProperties[i].Goify()
	}
	if r == Result(0) {
		r = SUCCESS
	}
...
var vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM = &vkCommand{"vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM", 4, true, nil}
...
// GetPipelineBinaryDataKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPipelineBinaryDataKHR.html
func GetPipelineBinaryDataKHR(device Device, info *PipelineBinaryDataInfoKHR) (pipelineBinaryKey PipelineBinaryKeyKHR, pipelineBinaryData []byte, r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkPipelineBinaryDataInfoKHR
	if info != nil {
		pInfo = info.Vulkanize()
	}

	// pipelineBinaryKey is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pPipelineBinaryKey *_vkPipelineBinaryKeyKHR = pipelineBinaryKey.Vulkanize()

	// pipelineBinaryData is a double-call array output
	var pipelineBinaryDataSize uintptr
	pPipelineBinaryDataSize := &pipelineBinaryDataSize
	// first trampoline happens here; also, still need to check returned Result value
	// NOT identical internal and external, result needs translation
	var pPipelineBinaryData *byte

	r = Result(execTrampoline(vkGetPipelineBinaryDataKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pPipelineBinaryKey)), uintptr(unsafe.Pointer(pPipelineBinaryDataSize)), uintptr(unsafe.Pointer(pPipelineBinaryData))))

	pipelineBinaryKey = *(pPipelineBinaryKey.Goify())
	sl_pPipelineBinaryData := make([]byte, pipelineBinaryDataSize)
	pipelineBinaryData = make([]byte, pipelineBinaryDataSize)
	pPipelineBinaryData = &sl_pPipelineBinaryData[0]

	// Trampoline call after last array allocation
	r = Result(execTrampoline(vkGetPipelineBinaryDataKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pPipelineBinaryKey)), uintptr(unsafe.Pointer(pPipelineBinaryDataSize)), uintptr(unsafe.Pointer(pPipelineBinaryData))))

	for i := range sl_pPipelineBinaryData {
		pipelineBinaryData[i] = *&sl_pPipelineBinaryData[i]
	}
	if r == Result(0) {
		r = SUCCESS
	}
...
var vkGetPipelineBinaryDataKHR = &vkCommand{"vkGetPipelineBinaryDataKHR", 5, true, nil}
...
// GetPipelineKeyKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPipelineKeyKHR.html
func GetPipelineKeyKHR(device Device, pipelineCreateInfo *PipelineCreateInfoKHR) (pipelineKey PipelineBinaryKeyKHR, r error) {
	// Parameter is a singular input, requires translation - pipelineCreateInfo
	var pPipelineCreateInfo *_vkPipelineCreateInfoKHR
	if pipelineCreateInfo != nil {
		pPipelineCreateInfo = pipelineCreateInfo.Vulkanize()
	}

	// pipelineKey is a binding-allocated single return value and will be populated by Vulkan, but requiring translation
	var pPipelineKey *_vkPipelineBinaryKeyKHR = pipelineKey.Vulkanize()

	r = Result(execTrampoline(vkGetPipelineKeyKHR, uintptr(device), uintptr(unsafe.Pointer(pPipelineCreateInfo)), uintptr(unsafe.Pointer(pPipelineKey))))

	pipelineKey = *(pPipelineKey.Goify())
	if r == Result(0) {
		r = SUCCESS
	}
	return
...
var vkGetPipelineKeyKHR = &vkCommand{"vkGetPipelineKeyKHR", 3, true, nil}
...
// GetRenderingAreaGranularity: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetRenderingAreaGranularity.html
func GetRenderingAreaGranularity(device Device, renderingAreaInfo *RenderingAreaInfo) (granularity Extent2D) {
	...
	var pRenderingAreaInfo *_vkRenderingAreaInfo
	...
	execTrampoline(vkGetRenderingAreaGranularity, uintptr(device), uintptr(unsafe.Pointer(pRenderingAreaInfo)), uintptr(unsafe.Pointer(ptr_pGranularity)))

	return
}

var vkGetRenderingAreaGranularity = &vkCommand{"vkGetRenderingAreaGranularity", 3, true, nil}
var GetRenderingAreaGranularityKHR = GetRenderingAreaGranularity
...
// GetTensorMemoryRequirementsARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetTensorMemoryRequirementsARM.html
func GetTensorMemoryRequirementsARM(device Device, info *TensorMemoryRequirementsInfoARM) (memoryRequirements MemoryRequirements2) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkTensorMemoryRequirementsInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	execTrampoline(vkGetTensorMemoryRequirementsARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))

	memoryRequirements = *(pMemoryRequirements.Goify())
	return
}

var vkGetTensorMemoryRequirementsARM = &vkCommand{"vkGetTensorMemoryRequirementsARM", 3, true, nil}

// GetTensorOpaqueCaptureDescriptorDataARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetTensorOpaqueCaptureDescriptorDataARM.html
func GetTensorOpaqueCaptureDescriptorDataARM(device Device, info *TensorCaptureDescriptorDataInfoARM) (data byte, r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkTensorCaptureDescriptorDataInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkGetTensorOpaqueCaptureDescriptorDataARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_pData))))
...
var vkGetTensorOpaqueCaptureDescriptorDataARM = &vkCommand{"vkGetTensorOpaqueCaptureDescriptorDataARM", 3, true, nil}

// GetTensorViewOpaqueCaptureDescriptorDataARM: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetTensorViewOpaqueCaptureDescriptorDataARM.html
func GetTensorViewOpaqueCaptureDescriptorDataARM(device Device, info *TensorViewCaptureDescriptorDataInfoARM) (data byte, r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkTensorViewCaptureDescriptorDataInfoARM
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkGetTensorViewOpaqueCaptureDescriptorDataARM, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_pData))))
...
var vkGetTensorViewOpaqueCaptureDescriptorDataARM = &vkCommand{"vkGetTensorViewOpaqueCaptureDescriptorDataARM", 3, true, nil}
...
// MapMemory2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkMapMemory2.html
func MapMemory2(device Device, memoryMapInfo *MemoryMapInfo) (pData *byte, r error) {
	// Parameter is a singular input, requires translation - memoryMapInfo
	var pMemoryMapInfo *_vkMemoryMapInfo
	...
	r = Result(execTrampoline(vkMapMemory2, uintptr(device), uintptr(unsafe.Pointer(pMemoryMapInfo)), uintptr(unsafe.Pointer(ptr_ppData))))
...
var vkMapMemory2 = &vkCommand{"vkMapMemory2", 3, true, nil}
var MapMemory2KHR = MapMemory2
...
// ReleaseCapturedPipelineDataKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkReleaseCapturedPipelineDataKHR.html
func ReleaseCapturedPipelineDataKHR(device Device, info *ReleaseCapturedPipelineDataInfoKHR, allocator *AllocationCallbacks) (r error) {
	// Parameter is a singular input, requires translation - info
	var pInfo *_vkReleaseCapturedPipelineDataInfoKHR
	if info != nil {
		pInfo = info.Vulkanize()
	}
	...
	r = Result(execTrampoline(vkReleaseCapturedPipelineDataKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pAllocator))))
...
var vkReleaseCapturedPipelineDataKHR = &vkCommand{"vkReleaseCapturedPipelineDataKHR", 3, true, nil}
...
var ReleaseSwapchainImagesEXT = ReleaseSwapchainImagesKHR

// ReleaseSwapchainImagesKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkReleaseSwapchainImagesKHR.html
func ReleaseSwapchainImagesKHR(device Device, releaseInfo *ReleaseSwapchainImagesInfoKHR) (r error) {
	// Parameter is a singular input, requires translation - releaseInfo
	var pReleaseInfo *_vkReleaseSwapchainImagesInfoKHR
	if releaseInfo != nil {
		pReleaseInfo = releaseInfo.Vulkanize()
	}

	r = Result(execTrampoline(vkReleaseSwapchainImagesKHR, uintptr(device), uintptr(unsafe.Pointer(pReleaseInfo))))
...
var vkReleaseSwapchainImagesKHR = &vkCommand{"vkReleaseSwapchainImagesKHR", 2, true, nil}
...
// TransitionImageLayout: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkTransitionImageLayout.html
func TransitionImageLayout(device Device, transitions []HostImageLayoutTransitionInfo) (r error) {
	transitionCount := len(transitions)
	// transitions is an input slice that requires translation to an internal type
	var pTransitions unsafe.Pointer
	if len(transitions) > 0 {
		sl_transitions := make([]_vkHostImageLayoutTransitionInfo, transitionCount)
	...
	r = Result(execTrampoline(vkTransitionImageLayout, uintptr(device), uintptr(transitionCount), uintptr(unsafe.Pointer(pTransitions))))
...
var vkTransitionImageLayout = &vkCommand{"vkTransitionImageLayout", 3, true, nil}
var TransitionImageLayoutEXT = TransitionImageLayout
...
// UnmapMemory2: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkUnmapMemory2.html
func UnmapMemory2(device Device, memoryUnmapInfo *MemoryUnmapInfo) (r error) {
	// Parameter is a singular input, requires translation - memoryUnmapInfo
	var pMemoryUnmapInfo *_vkMemoryUnmapInfo
	if memoryUnmapInfo != nil {
		pMemoryUnmapInfo = memoryUnmapInfo.Vulkanize()
	}

	r = Result(execTrampoline(vkUnmapMemory2, uintptr(device), uintptr(unsafe.Pointer(pMemoryUnmapInfo))))
...
var vkUnmapMemory2 = &vkCommand{"vkUnmapMemory2", 2, true, nil}
var UnmapMemory2KHR = UnmapMemory2
...
// UpdateIndirectExecutionSetPipelineEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkUpdateIndirectExecutionSetPipelineEXT.html
func UpdateIndirectExecutionSetPipelineEXT(device Device, indirectExecutionSet IndirectExecutionSetEXT, executionSetWrites []WriteIndirectExecutionSetPipelineEXT) {
	...
	// executionSetWrites is an input slice that requires translation to an internal type
	var pExecutionSetWrites unsafe.Pointer
	if len(executionSetWrites) > 0 {
		sl_executionSetWrites := make([]_vkWriteIndirectExecutionSetPipelineEXT, executionSetWriteCount)
		for i, v := range executionSetWrites {
			sl_executionSetWrites[i] = *(v.Vulkanize())
		}
		pExecutionSetWrites = unsafe.Pointer(&sl_executionSetWrites[0])
	}

	execTrampoline(vkUpdateIndirectExecutionSetPipelineEXT, uintptr(device), uintptr(indirectExecutionSet), uintptr(executionSetWriteCount), uintptr(unsafe.Pointer(pExecutionSetWrites)))

}

var vkUpdateIndirectExecutionSetPipelineEXT = &vkCommand{"vkUpdateIndirectExecutionSetPipelineEXT", 4, true, nil}

// UpdateIndirectExecutionSetShaderEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkUpdateIndirectExecutionSetShaderEXT.html
func UpdateIndirectExecutionSetShaderEXT(device Device, indirectExecutionSet IndirectExecutionSetEXT, executionSetWrites []WriteIndirectExecutionSetShaderEXT) {
	...
	var pExecutionSetWrites unsafe.Pointer
	if len(executionSetWrites) > 0 {
		sl_executionSetWrites := make([]_vkWriteIndirectExecutionSetShaderEXT, executionSetWriteCount)
		for i, v := range executionSetWrites {
			sl_executionSetWrites[i] = *(v.Vulkanize())
		}
		pExecutionSetWrites = unsafe.Pointer(&sl_executionSetWrites[0])
	...
	execTrampoline(vkUpdateIndirectExecutionSetShaderEXT, uintptr(device), uintptr(indirectExecutionSet), uintptr(executionSetWriteCount), uintptr(unsafe.Pointer(pExecutionSetWrites)))

}

var vkUpdateIndirectExecutionSetShaderEXT = &vkCommand{"vkUpdateIndirectExecutionSetShaderEXT", 4, true, nil}
...
// WaitForPresent2KHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkWaitForPresent2KHR.html
func WaitForPresent2KHR(device Device, swapchain SwapchainKHR, presentWait2Info *PresentWait2InfoKHR) (r error) {
	// Parameter is a singular input, requires translation - presentWait2Info
	var pPresentWait2Info *_vkPresentWait2InfoKHR
	if presentWait2Info != nil {
		pPresentWait2Info = presentWait2Info.Vulkanize()
	}

	r = Result(execTrampoline(vkWaitForPresent2KHR, uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(pPresentWait2Info))))
...
var vkWaitForPresent2KHR = &vkCommand{"vkWaitForPresent2KHR", 3, true, nil}
