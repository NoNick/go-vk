// Code generated by go-vk from vk.xml at 2025-10-26 13:04:50.00596819 +0000 UTC m=+9.413666449. DO NOT EDIT.
...
const (
	...
	ACCELERATION_STRUCTURE_CREATE_MOTION_BIT_NV                            AccelerationStructureCreateFlagBitsKHR = 1 << 2
	ACCELERATION_STRUCTURE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT AccelerationStructureCreateFlagBitsKHR = 1 << 3
)
...
const (
	...
	ACCESS_COMMAND_PREPROCESS_READ_BIT_NV                AccessFlagBits = 1 << 17
	ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV               AccessFlagBits = 1 << 18
	ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT     AccessFlagBits = 1 << 19
	ACCESS_VERTEX_ATTRIBUTE_READ_BIT                     AccessFlagBits = 1 << 2
	ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT            AccessFlagBits = 1 << 20 // read access flag for reading conditional rendering predicate
	...
	ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT             AccessFlagBits = 1 << 24
	ACCESS_TRANSFORM_FEEDBACK_WRITE_BIT_EXT              AccessFlagBits = 1 << 25
	ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT       AccessFlagBits = 1 << 26
	ACCESS_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT      AccessFlagBits = 1 << 27
...
const (
	...
	ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV                AccessFlagBits2 = 1 << 17
	ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV               AccessFlagBits2 = 1 << 18
	ACCESS_2_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT     AccessFlagBits2 = 1 << 19
	ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT                     AccessFlagBits2 = 1 << 2
	ACCESS_2_CONDITIONAL_RENDERING_READ_BIT_EXT            AccessFlagBits2 = 1 << 20 // read access flag for reading conditional rendering predicate
	ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_KHR           AccessFlagBits2 = 1 << 21
	ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_KHR          AccessFlagBits2 = 1 << 22
	ACCESS_2_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR AccessFlagBits2 = 1 << 23
	ACCESS_2_FRAGMENT_DENSITY_MAP_READ_BIT_EXT             AccessFlagBits2 = 1 << 24
	ACCESS_2_TRANSFORM_FEEDBACK_WRITE_BIT_EXT              AccessFlagBits2 = 1 << 25
	ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT       AccessFlagBits2 = 1 << 26
	ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT      AccessFlagBits2 = 1 << 27
	...
	ACCESS_2_VIDEO_DECODE_READ_BIT_KHR                     AccessFlagBits2 = 1 << 35
	ACCESS_2_VIDEO_DECODE_WRITE_BIT_KHR                    AccessFlagBits2 = 1 << 36
	ACCESS_2_VIDEO_ENCODE_READ_BIT_KHR                     AccessFlagBits2 = 1 << 37
	ACCESS_2_VIDEO_ENCODE_WRITE_BIT_KHR                    AccessFlagBits2 = 1 << 38
	ACCESS_2_INVOCATION_MASK_READ_BIT_HUAWEI               AccessFlagBits2 = 1 << 39
	ACCESS_2_INPUT_ATTACHMENT_READ_BIT                     AccessFlagBits2 = 1 << 4
	ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR             AccessFlagBits2 = 1 << 40
	ACCESS_2_DESCRIPTOR_BUFFER_READ_BIT_EXT                AccessFlagBits2 = 1 << 41
	ACCESS_2_OPTICAL_FLOW_READ_BIT_NV                      AccessFlagBits2 = 1 << 42
	ACCESS_2_OPTICAL_FLOW_WRITE_BIT_NV                     AccessFlagBits2 = 1 << 43
	ACCESS_2_MICROMAP_READ_BIT_EXT                         AccessFlagBits2 = 1 << 44
	ACCESS_2_MICROMAP_WRITE_BIT_EXT                        AccessFlagBits2 = 1 << 45
...
const (
	...
	ATTACHMENT_LOAD_OP_NONE_KHR  AttachmentLoadOp = 1000526000
	ATTACHMENT_LOAD_OP_NONE_EXT  AttachmentLoadOp = ATTACHMENT_LOAD_OP_NONE_KHR
)
...
const (
	...
	BUFFER_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT BufferCreateFlagBits = 1 << 5
	BUFFER_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR        BufferCreateFlagBits = 1 << 6
...
const (
	...
	BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR                         BufferUsageFlagBits = 1 << 10
	BUFFER_USAGE_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT                    BufferUsageFlagBits = 1 << 11
	BUFFER_USAGE_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT            BufferUsageFlagBits = 1 << 12
	BUFFER_USAGE_VIDEO_DECODE_SRC_BIT_KHR                             BufferUsageFlagBits = 1 << 13
	BUFFER_USAGE_VIDEO_DECODE_DST_BIT_KHR                             BufferUsageFlagBits = 1 << 14
	BUFFER_USAGE_VIDEO_ENCODE_DST_BIT_KHR                             BufferUsageFlagBits = 1 << 15
	BUFFER_USAGE_VIDEO_ENCODE_SRC_BIT_KHR                             BufferUsageFlagBits = 1 << 16
	...
	BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT                    BufferUsageFlagBits = 1 << 21
	BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT                   BufferUsageFlagBits = 1 << 22
	BUFFER_USAGE_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT               BufferUsageFlagBits = 1 << 23
	BUFFER_USAGE_MICROMAP_STORAGE_BIT_EXT                             BufferUsageFlagBits = 1 << 24
	BUFFER_USAGE_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT           BufferUsageFlagBits = 1 << 26
	...
	BUFFER_USAGE_CONDITIONAL_RENDERING_BIT_EXT                        BufferUsageFlagBits = 1 << 9 // Specifies the buffer can be used as predicate in conditional rendering
...
const (
	...
	BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR                         BufferUsageFlagBits2KHR = 1 << 10
	BUFFER_USAGE_2_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT                    BufferUsageFlagBits2KHR = 1 << 11
	BUFFER_USAGE_2_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT            BufferUsageFlagBits2KHR = 1 << 12
	BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR                             BufferUsageFlagBits2KHR = 1 << 13
	BUFFER_USAGE_2_VIDEO_DECODE_DST_BIT_KHR                             BufferUsageFlagBits2KHR = 1 << 14
	BUFFER_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR                             BufferUsageFlagBits2KHR = 1 << 15
	BUFFER_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR                             BufferUsageFlagBits2KHR = 1 << 16
	BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT_KHR                        BufferUsageFlagBits2KHR = 1 << 17
	BUFFER_USAGE_2_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR BufferUsageFlagBits2KHR = 1 << 19
	BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR                         BufferUsageFlagBits2KHR = 1 << 2
	BUFFER_USAGE_2_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR               BufferUsageFlagBits2KHR = 1 << 20
	BUFFER_USAGE_2_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT                    BufferUsageFlagBits2KHR = 1 << 21
	BUFFER_USAGE_2_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT                   BufferUsageFlagBits2KHR = 1 << 22
	BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT               BufferUsageFlagBits2KHR = 1 << 23
	BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT                             BufferUsageFlagBits2KHR = 1 << 24
	BUFFER_USAGE_2_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT           BufferUsageFlagBits2KHR = 1 << 26
	...
	BUFFER_USAGE_2_CONDITIONAL_RENDERING_BIT_EXT                        BufferUsageFlagBits2KHR = 1 << 9
...
const (
	...
	BUILD_ACCELERATION_STRUCTURE_ALLOW_DATA_ACCESS_KHR                  BuildAccelerationStructureFlagBitsKHR = 1 << 11
	...
	BUILD_ACCELERATION_STRUCTURE_MOTION_BIT_NV                          BuildAccelerationStructureFlagBitsKHR = 1 << 5
	BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_EXT      BuildAccelerationStructureFlagBitsKHR = 1 << 6
	BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_EXT    BuildAccelerationStructureFlagBitsKHR = 1 << 7
	BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_EXT BuildAccelerationStructureFlagBitsKHR = 1 << 8
...
const (
	...
	DEBUG_UTILS_MESSAGE_TYPE_DEVICE_ADDRESS_BINDING_BIT_EXT DebugUtilsMessageTypeFlagBitsEXT = 1 << 3
)
...
const (
	...
	DEPENDENCY_FEEDBACK_LOOP_BIT_EXT DependencyFlagBits = 1 << 3 // Dependency may be a feedback loop
...
const (
	...
	DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_EXT                 DescriptorPoolCreateFlagBits = 1 << 2
	DESCRIPTOR_POOL_CREATE_ALLOW_OVERALLOCATION_SETS_BIT_NV  DescriptorPoolCreateFlagBits = 1 << 3
	DESCRIPTOR_POOL_CREATE_ALLOW_OVERALLOCATION_POOLS_BIT_NV DescriptorPoolCreateFlagBits = 1 << 4
...
const (
	DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT_KHR             DescriptorSetLayoutCreateFlagBits = 1 << 0 // Descriptors are pushed via flink:vkCmdPushDescriptorSetKHR
	DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT          DescriptorSetLayoutCreateFlagBits = 1 << 1
	DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_EXT              DescriptorSetLayoutCreateFlagBits = 1 << 2
	DESCRIPTOR_SET_LAYOUT_CREATE_DESCRIPTOR_BUFFER_BIT_EXT           DescriptorSetLayoutCreateFlagBits = 1 << 4
	DESCRIPTOR_SET_LAYOUT_CREATE_EMBEDDED_IMMUTABLE_SAMPLERS_BIT_EXT DescriptorSetLayoutCreateFlagBits = 1 << 5
	DESCRIPTOR_SET_LAYOUT_CREATE_PER_STAGE_BIT_NV                    DescriptorSetLayoutCreateFlagBits = 1 << 6
	DESCRIPTOR_SET_LAYOUT_CREATE_INDIRECT_BINDABLE_BIT_NV            DescriptorSetLayoutCreateFlagBits = 1 << 7
...
const (
	...
	DRIVER_ID_RESERVED_27                   DriverId = 27 // Reserved for undisclosed driver project
...
const (
	...
	DYNAMIC_STATE_LINE_STIPPLE_KHR                        DynamicState = 1000534000
	...
	DYNAMIC_STATE_LINE_STIPPLE_EXT                        DynamicState = DYNAMIC_STATE_LINE_STIPPLE_KHR
...
const (
	...
	EXTERNAL_MEMORY_HANDLE_TYPE_RDMA_ADDRESS_BIT_NV                ExternalMemoryHandleTypeFlagBits = 1 << 12
	...
	EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT            ExternalMemoryHandleTypeFlagBits = 1 << 7
	EXTERNAL_MEMORY_HANDLE_TYPE_HOST_MAPPED_FOREIGN_MEMORY_BIT_EXT ExternalMemoryHandleTypeFlagBits = 1 << 8
	EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_BIT_EXT                    ExternalMemoryHandleTypeFlagBits = 1 << 9
...
const (
	...
	FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_BIT_EXT                                                    FormatFeatureFlagBits = 1 << 24
	FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR                                                     FormatFeatureFlagBits = 1 << 25
	FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR                                                        FormatFeatureFlagBits = 1 << 26
	FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR                                                      FormatFeatureFlagBits = 1 << 27
	FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR                                                        FormatFeatureFlagBits = 1 << 28
	...
	FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR                                        FormatFeatureFlagBits = 1 << 30
...
const (
	...
	FORMAT_FEATURE_2_FRAGMENT_DENSITY_MAP_BIT_EXT                                                    FormatFeatureFlagBits2 = 1 << 24
	FORMAT_FEATURE_2_VIDEO_DECODE_OUTPUT_BIT_KHR                                                     FormatFeatureFlagBits2 = 1 << 25
	FORMAT_FEATURE_2_VIDEO_DECODE_DPB_BIT_KHR                                                        FormatFeatureFlagBits2 = 1 << 26
	FORMAT_FEATURE_2_VIDEO_ENCODE_INPUT_BIT_KHR                                                      FormatFeatureFlagBits2 = 1 << 27
	FORMAT_FEATURE_2_VIDEO_ENCODE_DPB_BIT_KHR                                                        FormatFeatureFlagBits2 = 1 << 28
	...
	FORMAT_FEATURE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR                                        FormatFeatureFlagBits2 = 1 << 30
	...
	FORMAT_FEATURE_2_WEIGHT_IMAGE_BIT_QCOM                                                           FormatFeatureFlagBits2 = 1 << 34
	FORMAT_FEATURE_2_WEIGHT_SAMPLED_IMAGE_BIT_QCOM                                                   FormatFeatureFlagBits2 = 1 << 35
	FORMAT_FEATURE_2_BLOCK_MATCHING_BIT_QCOM                                                         FormatFeatureFlagBits2 = 1 << 36
	FORMAT_FEATURE_2_BOX_FILTER_SAMPLED_BIT_QCOM                                                     FormatFeatureFlagBits2 = 1 << 37
	FORMAT_FEATURE_2_LINEAR_COLOR_ATTACHMENT_BIT_NV                                                  FormatFeatureFlagBits2 = 1 << 38 // Format support linear image as render target, it cannot be mixed with non linear attachment
	FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT                                                        FormatFeatureFlagBits2 = 1 << 4
	FORMAT_FEATURE_2_OPTICAL_FLOW_IMAGE_BIT_NV                                                       FormatFeatureFlagBits2 = 1 << 40
	FORMAT_FEATURE_2_OPTICAL_FLOW_VECTOR_BIT_NV                                                      FormatFeatureFlagBits2 = 1 << 41
	FORMAT_FEATURE_2_OPTICAL_FLOW_COST_BIT_NV                                                        FormatFeatureFlagBits2 = 1 << 42
	FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT_EXT                                                     FormatFeatureFlagBits2 = 1 << 46 // Host image copies are supported
...
const (
	...
	GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_EXT      GeometryInstanceFlagBitsKHR = 1 << 4
	GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_EXT           GeometryInstanceFlagBitsKHR = 1 << 5
...
const (
	...
	IMAGE_ASPECT_MEMORY_PLANE_3_BIT_EXT ImageAspectFlagBits = 1 << 10
	...
	IMAGE_ASPECT_MEMORY_PLANE_0_BIT_EXT ImageAspectFlagBits = 1 << 7
	IMAGE_ASPECT_MEMORY_PLANE_1_BIT_EXT ImageAspectFlagBits = 1 << 8
	IMAGE_ASPECT_MEMORY_PLANE_2_BIT_EXT ImageAspectFlagBits = 1 << 9
...
const (
	...
	IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT     ImageCreateFlagBits = 1 << 12
	IMAGE_CREATE_CORNER_SAMPLED_BIT_NV                         ImageCreateFlagBits = 1 << 13
	IMAGE_CREATE_SUBSAMPLED_BIT_EXT                            ImageCreateFlagBits = 1 << 14
	IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_QCOM          ImageCreateFlagBits = 1 << 15
	IMAGE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT      ImageCreateFlagBits = 1 << 16
	IMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXT                    ImageCreateFlagBits = 1 << 17 // Image is created with a layout where individual slices are capable of being used as 2D images
	IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT ImageCreateFlagBits = 1 << 18
	IMAGE_CREATE_SPARSE_ALIASED_BIT                            ImageCreateFlagBits = 1 << 2
	IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR             ImageCreateFlagBits = 1 << 20
...
const (
	...
	IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR                       ImageLayout = 1000232000
...
const (
	...
	IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR                 ImageUsageFlagBits = 1 << 10
	IMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHR                 ImageUsageFlagBits = 1 << 11
	IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR                 ImageUsageFlagBits = 1 << 12
	IMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHR                 ImageUsageFlagBits = 1 << 13
	IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR                 ImageUsageFlagBits = 1 << 14
	IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR                 ImageUsageFlagBits = 1 << 15
	IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI               ImageUsageFlagBits = 1 << 18
	IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT         ImageUsageFlagBits = 1 << 19
	IMAGE_USAGE_SAMPLED_BIT                              ImageUsageFlagBits = 1 << 2
	IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM                   ImageUsageFlagBits = 1 << 20
	IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM              ImageUsageFlagBits = 1 << 21
	IMAGE_USAGE_HOST_TRANSFER_BIT_EXT                    ImageUsageFlagBits = 1 << 22 // Can be used with host image copies
	...
	IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT             ImageUsageFlagBits = 1 << 9
...
const (
	IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT     ImageViewCreateFlagBits = 1 << 0
	IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT    ImageViewCreateFlagBits = 1 << 1
	IMAGE_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT ImageViewCreateFlagBits = 1 << 2
)
...
const (
	...
	INDEX_TYPE_UINT8_KHR IndexType = 1000533000
	INDEX_TYPE_NONE_NV   IndexType = INDEX_TYPE_NONE_KHR
	INDEX_TYPE_UINT8_EXT IndexType = INDEX_TYPE_UINT8_KHR
)
...
const (
	INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR InstanceCreateFlagBits = 1 << 0
)
...
// LayerSettingTypeEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkLayerSettingTypeEXT.html
...
// LineRasterizationModeKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkLineRasterizationModeKHR.html
type LineRasterizationModeKHR int32
...
const (
	...
	LINE_RASTERIZATION_MODE_BRESENHAM_EXT          LineRasterizationModeKHR = LINE_RASTERIZATION_MODE_BRESENHAM_KHR
	LINE_RASTERIZATION_MODE_DEFAULT_EXT            LineRasterizationModeKHR = LINE_RASTERIZATION_MODE_DEFAULT_KHR
	LINE_RASTERIZATION_MODE_RECTANGULAR_EXT        LineRasterizationModeKHR = LINE_RASTERIZATION_MODE_RECTANGULAR_KHR
	LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_EXT LineRasterizationModeKHR = LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_KHR
)
...
const (
	MEMORY_MAP_PLACED_BIT_EXT MemoryMapFlagBits = 1 << 0
)
...
const (
	...
	MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD MemoryPropertyFlagBits = 1 << 6
	MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD MemoryPropertyFlagBits = 1 << 7
	MEMORY_PROPERTY_RDMA_CAPABLE_BIT_NV     MemoryPropertyFlagBits = 1 << 8
)

type MemoryUnmapFlagBitsKHR = MemoryUnmapFlagsKHR

const (
	MEMORY_UNMAP_RESERVE_BIT_EXT MemoryUnmapFlagBitsKHR = 1 << 0
)
...
// PhysicalDeviceLayeredApiKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceLayeredApiKHR.html
...
const (
	PIPELINE_COLOR_BLEND_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_BIT_EXT PipelineColorBlendStateCreateFlagBits = 1 << 0
...
const (
	...
	PIPELINE_CREATE_LINK_TIME_OPTIMIZATION_BIT_EXT                               PipelineCreateFlagBits = 1 << 10
	PIPELINE_CREATE_LIBRARY_BIT_KHR                                              PipelineCreateFlagBits = 1 << 11
	PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR                           PipelineCreateFlagBits = 1 << 12
	PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR                               PipelineCreateFlagBits = 1 << 13
	PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR                  PipelineCreateFlagBits = 1 << 14
	PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR              PipelineCreateFlagBits = 1 << 15
	PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR                     PipelineCreateFlagBits = 1 << 16
	PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR             PipelineCreateFlagBits = 1 << 17
	PIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NV                                     PipelineCreateFlagBits = 1 << 18
	PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR       PipelineCreateFlagBits = 1 << 19
	PIPELINE_CREATE_DERIVATIVE_BIT                                               PipelineCreateFlagBits = 1 << 2
	PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV                              PipelineCreateFlagBits = 1 << 20
	PIPELINE_CREATE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR           PipelineCreateFlagBits = 1 << 21
	PIPELINE_CREATE_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT            PipelineCreateFlagBits = 1 << 22
	PIPELINE_CREATE_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT                   PipelineCreateFlagBits = 1 << 23
	PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT                         PipelineCreateFlagBits = 1 << 24
	PIPELINE_CREATE_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT                       PipelineCreateFlagBits = 1 << 25
	PIPELINE_CREATE_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT               PipelineCreateFlagBits = 1 << 26
	PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT_EXT                                  PipelineCreateFlagBits = 1 << 27
	PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT                                    PipelineCreateFlagBits = 1 << 29
	PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT                             PipelineCreateFlagBits = 1 << 3
	PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT_EXT                                PipelineCreateFlagBits = 1 << 30
	PIPELINE_CREATE_DISPATCH_BASE_BIT                                            PipelineCreateFlagBits = 1 << 4
	PIPELINE_CREATE_DEFER_COMPILE_BIT_NV                                         PipelineCreateFlagBits = 1 << 5
	PIPELINE_CREATE_CAPTURE_STATISTICS_BIT_KHR                                   PipelineCreateFlagBits = 1 << 6
	PIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR                     PipelineCreateFlagBits = 1 << 7
...
const (
	...
	PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT                         PipelineCreateFlagBits2KHR = 1 << 10
	PIPELINE_CREATE_2_LIBRARY_BIT_KHR                                        PipelineCreateFlagBits2KHR = 1 << 11
	PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR                     PipelineCreateFlagBits2KHR = 1 << 12
	PIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHR                         PipelineCreateFlagBits2KHR = 1 << 13
	PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR            PipelineCreateFlagBits2KHR = 1 << 14
	PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR        PipelineCreateFlagBits2KHR = 1 << 15
	PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR               PipelineCreateFlagBits2KHR = 1 << 16
	PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR       PipelineCreateFlagBits2KHR = 1 << 17
	PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV                               PipelineCreateFlagBits2KHR = 1 << 18
	PIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR PipelineCreateFlagBits2KHR = 1 << 19
	PIPELINE_CREATE_2_DERIVATIVE_BIT_KHR                                     PipelineCreateFlagBits2KHR = 1 << 2
	PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV                        PipelineCreateFlagBits2KHR = 1 << 20
	PIPELINE_CREATE_2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR     PipelineCreateFlagBits2KHR = 1 << 21
	PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT      PipelineCreateFlagBits2KHR = 1 << 22
	PIPELINE_CREATE_2_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT             PipelineCreateFlagBits2KHR = 1 << 23
	PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT                   PipelineCreateFlagBits2KHR = 1 << 24
	PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT                 PipelineCreateFlagBits2KHR = 1 << 25
	PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT         PipelineCreateFlagBits2KHR = 1 << 26
	PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT_EXT                            PipelineCreateFlagBits2KHR = 1 << 27
	PIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NV               PipelineCreateFlagBits2KHR = 1 << 28
	PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT                              PipelineCreateFlagBits2KHR = 1 << 29
	PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR                   PipelineCreateFlagBits2KHR = 1 << 3
	PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT                          PipelineCreateFlagBits2KHR = 1 << 30
	PIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT                        PipelineCreateFlagBits2KHR = 1 << 34
	PIPELINE_CREATE_2_DISPATCH_BASE_BIT_KHR                                  PipelineCreateFlagBits2KHR = 1 << 4
	PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV                                   PipelineCreateFlagBits2KHR = 1 << 5
	PIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHR                             PipelineCreateFlagBits2KHR = 1 << 6
	PIPELINE_CREATE_2_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR               PipelineCreateFlagBits2KHR = 1 << 7
	PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHR              PipelineCreateFlagBits2KHR = 1 << 8
	PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT_KHR                        PipelineCreateFlagBits2KHR = 1 << 9
)
...
const (
	PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT   PipelineDepthStencilStateCreateFlagBits = 1 << 0
	PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT PipelineDepthStencilStateCreateFlagBits = 1 << 1
...
const (
	PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT PipelineLayoutCreateFlagBits = 1 << 1
)
...
const (
	...
	PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV                PipelineStageFlagBits = 1 << 17
	PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT            PipelineStageFlagBits = 1 << 18 // A pipeline stage for conditional rendering predicate fetch
	PIPELINE_STAGE_TASK_SHADER_BIT_EXT                      PipelineStageFlagBits = 1 << 19
	PIPELINE_STAGE_VERTEX_INPUT_BIT                         PipelineStageFlagBits = 1 << 2
	PIPELINE_STAGE_MESH_SHADER_BIT_EXT                      PipelineStageFlagBits = 1 << 20
	PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR               PipelineStageFlagBits = 1 << 21
	PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR PipelineStageFlagBits = 1 << 22
	PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT         PipelineStageFlagBits = 1 << 23
	PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT               PipelineStageFlagBits = 1 << 24
...
const (
	...
	PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV                PipelineStageFlagBits2 = 1 << 17
	PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT            PipelineStageFlagBits2 = 1 << 18 // A pipeline stage for conditional rendering predicate fetch
	PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT                      PipelineStageFlagBits2 = 1 << 19
	PIPELINE_STAGE_2_VERTEX_INPUT_BIT                         PipelineStageFlagBits2 = 1 << 2
	PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT                      PipelineStageFlagBits2 = 1 << 20
	PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR               PipelineStageFlagBits2 = 1 << 21
	PIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR PipelineStageFlagBits2 = 1 << 22
	PIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXT         PipelineStageFlagBits2 = 1 << 23
	PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT               PipelineStageFlagBits2 = 1 << 24
	PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR     PipelineStageFlagBits2 = 1 << 25
	PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR                     PipelineStageFlagBits2 = 1 << 26
	PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR                     PipelineStageFlagBits2 = 1 << 27
	PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR      PipelineStageFlagBits2 = 1 << 28
	PIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NV                      PipelineStageFlagBits2 = 1 << 29
	PIPELINE_STAGE_2_VERTEX_SHADER_BIT                        PipelineStageFlagBits2 = 1 << 3
	PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT                   PipelineStageFlagBits2 = 1 << 30
	...
	PIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEI                PipelineStageFlagBits2 = 1 << 39
	PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT          PipelineStageFlagBits2 = 1 << 4
	PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI               PipelineStageFlagBits2 = 1 << 40
	PIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEI        PipelineStageFlagBits2 = 1 << 41
...
const (
	...
	QUERY_PIPELINE_STATISTIC_TASK_SHADER_INVOCATIONS_BIT_EXT                QueryPipelineStatisticFlagBits = 1 << 11
	QUERY_PIPELINE_STATISTIC_MESH_SHADER_INVOCATIONS_BIT_EXT                QueryPipelineStatisticFlagBits = 1 << 12
	QUERY_PIPELINE_STATISTIC_CLUSTER_CULLING_SHADER_INVOCATIONS_BIT_HUAWEI  QueryPipelineStatisticFlagBits = 1 << 13
...
const (
	...
	QUERY_RESULT_WITH_STATUS_BIT_KHR   QueryResultFlagBits = 1 << 4
)
...
const (
	...
	QUEUE_VIDEO_DECODE_BIT_KHR QueueFlagBits = 1 << 5
	QUEUE_VIDEO_ENCODE_BIT_KHR QueueFlagBits = 1 << 6
	QUEUE_OPTICAL_FLOW_BIT_NV  QueueFlagBits = 1 << 8
)
...
const (
	RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM RenderPassCreateFlagBits = 1 << 1
)
...
const (
	...
	RENDERING_ENABLE_LEGACY_DITHERING_BIT_EXT            RenderingFlagBits = 1 << 3
	RENDERING_CONTENTS_INLINE_BIT_KHR                    RenderingFlagBits = 1 << 4 // Promoted from extension 452
	RENDERING_CONTENTS_INLINE_BIT_EXT                    RenderingFlagBits = RENDERING_CONTENTS_INLINE_BIT_KHR
...
const (
	SAMPLER_CREATE_SUBSAMPLED_BIT_EXT                       SamplerCreateFlagBits = 1 << 0
	SAMPLER_CREATE_SUBSAMPLED_COARSE_RECONSTRUCTION_BIT_EXT SamplerCreateFlagBits = 1 << 1
	SAMPLER_CREATE_NON_SEAMLESS_CUBE_MAP_BIT_EXT            SamplerCreateFlagBits = 1 << 2
	SAMPLER_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT SamplerCreateFlagBits = 1 << 3
	SAMPLER_CREATE_IMAGE_PROCESSING_BIT_QCOM                SamplerCreateFlagBits = 1 << 4
)
...
const (
	...
	SHADER_STAGE_CLOSEST_HIT_BIT_KHR         ShaderStageFlagBits = 1 << 10
	SHADER_STAGE_MISS_BIT_KHR                ShaderStageFlagBits = 1 << 11
	SHADER_STAGE_INTERSECTION_BIT_KHR        ShaderStageFlagBits = 1 << 12
	SHADER_STAGE_CALLABLE_BIT_KHR            ShaderStageFlagBits = 1 << 13
	SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI  ShaderStageFlagBits = 1 << 14
	SHADER_STAGE_CLUSTER_CULLING_BIT_HUAWEI  ShaderStageFlagBits = 1 << 19
	...
	SHADER_STAGE_TASK_BIT_EXT                ShaderStageFlagBits = 1 << 6
	SHADER_STAGE_MESH_BIT_EXT                ShaderStageFlagBits = 1 << 7
	SHADER_STAGE_RAYGEN_BIT_KHR              ShaderStageFlagBits = 1 << 8
	SHADER_STAGE_ANY_HIT_BIT_KHR             ShaderStageFlagBits = 1 << 9
...
const (
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR           StructureType = 1000232000
	STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO_KHR                              StructureType = 1000232001
	STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO_KHR                           StructureType = 1000232002
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES_KHR                 StructureType = 1000416000
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_KHR             StructureType = 1000525000
	STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_KHR                 StructureType = 1000525001
	STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR               StructureType = 1000525002
	STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES_KHR                StructureType = 1000528000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_DRIVER_PROPERTIES_MSFT                      StructureType = 1000530000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_KHR                       StructureType = 1000533000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_KHR                     StructureType = 1000534000
	STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_KHR                   StructureType = 1000534001
	STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_KHR                   StructureType = 1000534002
	STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_KHR                                       StructureType = 1000543000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES_KHR                   StructureType = 1000544000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES_KHR                          StructureType = 1000545000
	STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES_KHR                        StructureType = 1000545001
	STRUCTURE_TYPE_BIND_MEMORY_STATUS_KHR                                              StructureType = 1000545002
	STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO_KHR                                       StructureType = 1000545003
	STRUCTURE_TYPE_PUSH_CONSTANTS_INFO_KHR                                             StructureType = 1000545004
	STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO_KHR                                        StructureType = 1000545005
	STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO_KHR                          StructureType = 1000545006
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_EXT                       StructureType = STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_KHR
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT                     StructureType = STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_KHR
	STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_EXT                   StructureType = STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_KHR
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT               StructureType = STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR
	...
	STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_EXT                   StructureType = STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_KHR
	...
	STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT                 StructureType = STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_KHR
...
const (
	...
	SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT_KHR SubgroupFeatureFlagBits = 1 << 10
	...
	SUBGROUP_FEATURE_PARTITIONED_BIT_NV       SubgroupFeatureFlagBits = 1 << 8
	SUBGROUP_FEATURE_ROTATE_BIT_KHR           SubgroupFeatureFlagBits = 1 << 9
)
...
const (
	...
	SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR SubpassContents = 1000562000
...
const (
	SUBPASS_DESCRIPTION_PER_VIEW_ATTRIBUTES_BIT_NVX                           SubpassDescriptionFlagBits = 1 << 0
	SUBPASS_DESCRIPTION_PER_VIEW_POSITION_X_ONLY_BIT_NVX                      SubpassDescriptionFlagBits = 1 << 1
	SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM                              SubpassDescriptionFlagBits = 1 << 2
	SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM                               SubpassDescriptionFlagBits = 1 << 3
	SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_EXT   SubpassDescriptionFlagBits = 1 << 4
	SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT   SubpassDescriptionFlagBits = 1 << 5
	SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT SubpassDescriptionFlagBits = 1 << 6
	SUBPASS_DESCRIPTION_ENABLE_LEGACY_DITHERING_BIT_EXT                       SubpassDescriptionFlagBits = 1 << 7
...
const (
	SWAPCHAIN_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR SwapchainCreateFlagBitsKHR = 1 << 0 // Allow images with VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT
	SWAPCHAIN_CREATE_PROTECTED_BIT_KHR                   SwapchainCreateFlagBitsKHR = 1 << 1 // Swapchain is protected
	SWAPCHAIN_CREATE_MUTABLE_FORMAT_BIT_KHR              SwapchainCreateFlagBitsKHR = 1 << 2
	SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_EXT  SwapchainCreateFlagBitsKHR = 1 << 3
)
...
// TimeDomainKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkTimeDomainKHR.html
...
const (
	...
	TOOL_PURPOSE_DEBUG_REPORTING_BIT_EXT     ToolPurposeFlagBits = 1 << 5
	TOOL_PURPOSE_DEBUG_MARKERS_BIT_EXT       ToolPurposeFlagBits = 1 << 6
...
const (
	...
	VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR VideoCodecOperationFlagBitsKHR = 1 << 0
	VIDEO_CODEC_OPERATION_DECODE_H265_BIT_KHR VideoCodecOperationFlagBitsKHR = 1 << 1
	VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR VideoCodecOperationFlagBitsKHR = 1 << 16
	VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR VideoCodecOperationFlagBitsKHR = 1 << 17
	VIDEO_CODEC_OPERATION_DECODE_AV1_BIT_KHR  VideoCodecOperationFlagBitsKHR = 1 << 2
)
...
const (
	...
	VIDEO_CODING_CONTROL_ENCODE_RATE_CONTROL_BIT_KHR  VideoCodingControlFlagBitsKHR = 1 << 1
	VIDEO_CODING_CONTROL_ENCODE_QUALITY_LEVEL_BIT_KHR VideoCodingControlFlagBitsKHR = 1 << 2
)
...
const (
	VIDEO_ENCODE_CAPABILITY_PRECEDING_EXTERNALLY_ENCODED_BYTES_BIT_KHR            VideoEncodeCapabilityFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_CAPABILITY_INSUFFICIENT_BITSTREAM_BUFFER_RANGE_DETECTION_BIT_KHR VideoEncodeCapabilityFlagBitsKHR = 1 << 1
)

type VideoEncodeContentFlagBitsKHR = VideoEncodeContentFlagsKHR

const (
	VIDEO_ENCODE_CONTENT_DEFAULT_KHR      VideoEncodeContentFlagBitsKHR = 0
	VIDEO_ENCODE_CONTENT_CAMERA_BIT_KHR   VideoEncodeContentFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_CONTENT_DESKTOP_BIT_KHR  VideoEncodeContentFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_CONTENT_RENDERED_BIT_KHR VideoEncodeContentFlagBitsKHR = 1 << 2
)

type VideoEncodeFeedbackFlagBitsKHR = VideoEncodeFeedbackFlagsKHR

const (
	VIDEO_ENCODE_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR VideoEncodeFeedbackFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_FEEDBACK_BITSTREAM_BYTES_WRITTEN_BIT_KHR VideoEncodeFeedbackFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR VideoEncodeFeedbackFlagBitsKHR = 1 << 2
)

type VideoEncodeH264CapabilityFlagBitsKHR = VideoEncodeH264CapabilityFlagsKHR

const (
	VIDEO_ENCODE_H264_CAPABILITY_HRD_COMPLIANCE_BIT_KHR                    VideoEncodeH264CapabilityFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H264_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR VideoEncodeH264CapabilityFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H264_CAPABILITY_ROW_UNALIGNED_SLICE_BIT_KHR               VideoEncodeH264CapabilityFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H264_CAPABILITY_DIFFERENT_SLICE_TYPE_BIT_KHR              VideoEncodeH264CapabilityFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR                VideoEncodeH264CapabilityFlagBitsKHR = 1 << 4
	VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR                VideoEncodeH264CapabilityFlagBitsKHR = 1 << 5
	VIDEO_ENCODE_H264_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR       VideoEncodeH264CapabilityFlagBitsKHR = 1 << 6
	VIDEO_ENCODE_H264_CAPABILITY_PER_SLICE_CONSTANT_QP_BIT_KHR             VideoEncodeH264CapabilityFlagBitsKHR = 1 << 7
	VIDEO_ENCODE_H264_CAPABILITY_GENERATE_PREFIX_NALU_BIT_KHR              VideoEncodeH264CapabilityFlagBitsKHR = 1 << 8
)

type VideoEncodeH264RateControlFlagBitsKHR = VideoEncodeH264RateControlFlagsKHR

const (
	VIDEO_ENCODE_H264_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_KHR        VideoEncodeH264RateControlFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H264_RATE_CONTROL_REGULAR_GOP_BIT_KHR                   VideoEncodeH264RateControlFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H264_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR        VideoEncodeH264RateControlFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H264_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR      VideoEncodeH264RateControlFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H264_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR VideoEncodeH264RateControlFlagBitsKHR = 1 << 4
)

type VideoEncodeH264StdFlagBitsKHR = VideoEncodeH264StdFlagsKHR

const (
	VIDEO_ENCODE_H264_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR            VideoEncodeH264StdFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H264_STD_QPPRIME_Y_ZERO_TRANSFORM_BYPASS_FLAG_SET_BIT_KHR VideoEncodeH264StdFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H264_STD_DIRECT_SPATIAL_MV_PRED_FLAG_UNSET_BIT_KHR        VideoEncodeH264StdFlagBitsKHR = 1 << 10
	VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR           VideoEncodeH264StdFlagBitsKHR = 1 << 11
	VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR             VideoEncodeH264StdFlagBitsKHR = 1 << 12
	VIDEO_ENCODE_H264_STD_DIRECT_8X8_INFERENCE_FLAG_UNSET_BIT_KHR          VideoEncodeH264StdFlagBitsKHR = 1 << 13
	VIDEO_ENCODE_H264_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR          VideoEncodeH264StdFlagBitsKHR = 1 << 14
	VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_DISABLED_BIT_KHR               VideoEncodeH264StdFlagBitsKHR = 1 << 15
	VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_ENABLED_BIT_KHR                VideoEncodeH264StdFlagBitsKHR = 1 << 16
	VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_PARTIAL_BIT_KHR                VideoEncodeH264StdFlagBitsKHR = 1 << 17
	VIDEO_ENCODE_H264_STD_SLICE_QP_DELTA_BIT_KHR                           VideoEncodeH264StdFlagBitsKHR = 1 << 19
	VIDEO_ENCODE_H264_STD_SCALING_MATRIX_PRESENT_FLAG_SET_BIT_KHR          VideoEncodeH264StdFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H264_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR                 VideoEncodeH264StdFlagBitsKHR = 1 << 20
	VIDEO_ENCODE_H264_STD_CHROMA_QP_INDEX_OFFSET_BIT_KHR                   VideoEncodeH264StdFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H264_STD_SECOND_CHROMA_QP_INDEX_OFFSET_BIT_KHR            VideoEncodeH264StdFlagBitsKHR = 1 << 4
	VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR                      VideoEncodeH264StdFlagBitsKHR = 1 << 5
	VIDEO_ENCODE_H264_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR                   VideoEncodeH264StdFlagBitsKHR = 1 << 6
	VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_EXPLICIT_BIT_KHR             VideoEncodeH264StdFlagBitsKHR = 1 << 7
	VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_IMPLICIT_BIT_KHR             VideoEncodeH264StdFlagBitsKHR = 1 << 8
	VIDEO_ENCODE_H264_STD_TRANSFORM_8X8_MODE_FLAG_SET_BIT_KHR              VideoEncodeH264StdFlagBitsKHR = 1 << 9
)

type VideoEncodeH265CapabilityFlagBitsKHR = VideoEncodeH265CapabilityFlagsKHR

const (
	VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_KHR                    VideoEncodeH265CapabilityFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H265_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR VideoEncodeH265CapabilityFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_KHR       VideoEncodeH265CapabilityFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_SEGMENT_TYPE_BIT_KHR      VideoEncodeH265CapabilityFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR                VideoEncodeH265CapabilityFlagBitsKHR = 1 << 4
	VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR                VideoEncodeH265CapabilityFlagBitsKHR = 1 << 5
	VIDEO_ENCODE_H265_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR       VideoEncodeH265CapabilityFlagBitsKHR = 1 << 6
	VIDEO_ENCODE_H265_CAPABILITY_PER_SLICE_SEGMENT_CONSTANT_QP_BIT_KHR     VideoEncodeH265CapabilityFlagBitsKHR = 1 << 7
	VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILES_PER_SLICE_SEGMENT_BIT_KHR  VideoEncodeH265CapabilityFlagBitsKHR = 1 << 8
	VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_SEGMENTS_PER_TILE_BIT_KHR  VideoEncodeH265CapabilityFlagBitsKHR = 1 << 9
)

type VideoEncodeH265CtbSizeFlagBitsKHR = VideoEncodeH265CtbSizeFlagsKHR

const (
	VIDEO_ENCODE_H265_CTB_SIZE_16_BIT_KHR VideoEncodeH265CtbSizeFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H265_CTB_SIZE_32_BIT_KHR VideoEncodeH265CtbSizeFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H265_CTB_SIZE_64_BIT_KHR VideoEncodeH265CtbSizeFlagBitsKHR = 1 << 2
)

type VideoEncodeH265RateControlFlagBitsKHR = VideoEncodeH265RateControlFlagsKHR

const (
	VIDEO_ENCODE_H265_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_KHR            VideoEncodeH265RateControlFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H265_RATE_CONTROL_REGULAR_GOP_BIT_KHR                       VideoEncodeH265RateControlFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR            VideoEncodeH265RateControlFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR          VideoEncodeH265RateControlFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H265_RATE_CONTROL_TEMPORAL_SUB_LAYER_PATTERN_DYADIC_BIT_KHR VideoEncodeH265RateControlFlagBitsKHR = 1 << 4
)

type VideoEncodeH265StdFlagBitsKHR = VideoEncodeH265StdFlagsKHR

const (
	VIDEO_ENCODE_H265_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR                VideoEncodeH265StdFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H265_STD_SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET_BIT_KHR      VideoEncodeH265StdFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_KHR              VideoEncodeH265StdFlagBitsKHR = 1 << 10
	VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_KHR            VideoEncodeH265StdFlagBitsKHR = 1 << 11
	VIDEO_ENCODE_H265_STD_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET_BIT_KHR VideoEncodeH265StdFlagBitsKHR = 1 << 12
	VIDEO_ENCODE_H265_STD_TRANSQUANT_BYPASS_ENABLED_FLAG_SET_BIT_KHR           VideoEncodeH265StdFlagBitsKHR = 1 << 13
	VIDEO_ENCODE_H265_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR              VideoEncodeH265StdFlagBitsKHR = 1 << 14
	VIDEO_ENCODE_H265_STD_ENTROPY_CODING_SYNC_ENABLED_FLAG_SET_BIT_KHR         VideoEncodeH265StdFlagBitsKHR = 1 << 15
	VIDEO_ENCODE_H265_STD_DEBLOCKING_FILTER_OVERRIDE_ENABLED_FLAG_SET_BIT_KHR  VideoEncodeH265StdFlagBitsKHR = 1 << 16
	VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENTS_ENABLED_FLAG_SET_BIT_KHR    VideoEncodeH265StdFlagBitsKHR = 1 << 17
	VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENT_FLAG_SET_BIT_KHR             VideoEncodeH265StdFlagBitsKHR = 1 << 18
	VIDEO_ENCODE_H265_STD_SLICE_QP_DELTA_BIT_KHR                               VideoEncodeH265StdFlagBitsKHR = 1 << 19
	VIDEO_ENCODE_H265_STD_SCALING_LIST_DATA_PRESENT_FLAG_SET_BIT_KHR           VideoEncodeH265StdFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H265_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR                     VideoEncodeH265StdFlagBitsKHR = 1 << 20
	VIDEO_ENCODE_H265_STD_PCM_ENABLED_FLAG_SET_BIT_KHR                         VideoEncodeH265StdFlagBitsKHR = 1 << 3
	VIDEO_ENCODE_H265_STD_SPS_TEMPORAL_MVP_ENABLED_FLAG_SET_BIT_KHR            VideoEncodeH265StdFlagBitsKHR = 1 << 4
	VIDEO_ENCODE_H265_STD_INIT_QP_MINUS26_BIT_KHR                              VideoEncodeH265StdFlagBitsKHR = 1 << 5
	VIDEO_ENCODE_H265_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR                       VideoEncodeH265StdFlagBitsKHR = 1 << 6
	VIDEO_ENCODE_H265_STD_WEIGHTED_BIPRED_FLAG_SET_BIT_KHR                     VideoEncodeH265StdFlagBitsKHR = 1 << 7
	VIDEO_ENCODE_H265_STD_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_KHR             VideoEncodeH265StdFlagBitsKHR = 1 << 8
	VIDEO_ENCODE_H265_STD_SIGN_DATA_HIDING_ENABLED_FLAG_SET_BIT_KHR            VideoEncodeH265StdFlagBitsKHR = 1 << 9
)

type VideoEncodeH265TransformBlockSizeFlagBitsKHR = VideoEncodeH265TransformBlockSizeFlagsKHR

const (
	VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_4_BIT_KHR  VideoEncodeH265TransformBlockSizeFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_8_BIT_KHR  VideoEncodeH265TransformBlockSizeFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_16_BIT_KHR VideoEncodeH265TransformBlockSizeFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_32_BIT_KHR VideoEncodeH265TransformBlockSizeFlagBitsKHR = 1 << 3
)

type VideoEncodeRateControlModeFlagBitsKHR = VideoEncodeRateControlModeFlagsKHR

const (
	VIDEO_ENCODE_RATE_CONTROL_MODE_DEFAULT_KHR      VideoEncodeRateControlModeFlagBitsKHR = 0
	VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VideoEncodeRateControlModeFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_RATE_CONTROL_MODE_CBR_BIT_KHR      VideoEncodeRateControlModeFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_RATE_CONTROL_MODE_VBR_BIT_KHR      VideoEncodeRateControlModeFlagBitsKHR = 1 << 2
)

// VideoEncodeTuningModeKHR: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkVideoEncodeTuningModeKHR.html
...
const (
	VIDEO_ENCODE_USAGE_DEFAULT_KHR          VideoEncodeUsageFlagBitsKHR = 0
	VIDEO_ENCODE_USAGE_TRANSCODING_BIT_KHR  VideoEncodeUsageFlagBitsKHR = 1 << 0
	VIDEO_ENCODE_USAGE_STREAMING_BIT_KHR    VideoEncodeUsageFlagBitsKHR = 1 << 1
	VIDEO_ENCODE_USAGE_RECORDING_BIT_KHR    VideoEncodeUsageFlagBitsKHR = 1 << 2
	VIDEO_ENCODE_USAGE_CONFERENCING_BIT_KHR VideoEncodeUsageFlagBitsKHR = 1 << 3
)
...
const (
	...
	VIDEO_SESSION_CREATE_ALLOW_ENCODE_PARAMETER_OPTIMIZATIONS_BIT_KHR VideoSessionCreateFlagBitsKHR = 1 << 1
	VIDEO_SESSION_CREATE_INLINE_QUERIES_BIT_KHR                       VideoSessionCreateFlagBitsKHR = 1 << 2
)
