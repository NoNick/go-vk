...
const (
	...
	_GeometryInstanceFlagBitsKHR_name_4 = "GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_EXT"
)
...
func (i GeometryTypeKHR) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_GeometryTypeKHR_index)-1 {
		return "GeometryTypeKHR(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _GeometryTypeKHR_name[_GeometryTypeKHR_index[idx]:_GeometryTypeKHR_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i HostImageCopyFlagBitsEXT) String() string {
	idx := int(i) - 1
	if i < 1 || idx >= len(_HostImageCopyFlagBitsEXT_index)-1 {
		return "HostImageCopyFlagBitsEXT(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _HostImageCopyFlagBitsEXT_name[_HostImageCopyFlagBitsEXT_index[idx]:_HostImageCopyFlagBitsEXT_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
const _ImageCreateFlagBits_name = "IMAGE_CREATE_SPARSE_BINDING_BITIMAGE_CREATE_SPARSE_RESIDENCY_BITIMAGE_CREATE_SPARSE_ALIASED_BITIMAGE_CREATE_MUTABLE_FORMAT_BITIMAGE_CREATE_CUBE_COMPATIBLE_BITIMAGE_CREATE_2D_ARRAY_COMPATIBLE_BITIMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BITIMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BITIMAGE_CREATE_EXTENDED_USAGE_BITIMAGE_CREATE_DISJOINT_BITIMAGE_CREATE_ALIAS_BITIMAGE_CREATE_PROTECTED_BITIMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXTIMAGE_CREATE_CORNER_SAMPLED_BIT_NVIMAGE_CREATE_SUBSAMPLED_BIT_EXTIMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_QCOMIMAGE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXTIMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXTIMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXTIMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR"
...
var _ImageCreateFlagBits_map = map[ImageCreateFlagBits]string{
	...
	32768:   _ImageCreateFlagBits_name[505:554],
	65536:   _ImageCreateFlagBits_name[554:607],
	131072:  _ImageCreateFlagBits_name[607:646],
	262144:  _ImageCreateFlagBits_name[646:704],
	1048576: _ImageCreateFlagBits_name[704:750],
}
...
const _ImageLayout_name = "IMAGE_LAYOUT_UNDEFINEDIMAGE_LAYOUT_GENERALIMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMALIMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMALIMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMALIMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMALIMAGE_LAYOUT_TRANSFER_SRC_OPTIMALIMAGE_LAYOUT_TRANSFER_DST_OPTIMALIMAGE_LAYOUT_PREINITIALIZEDIMAGE_LAYOUT_PRESENT_SRC_KHRIMAGE_LAYOUT_VIDEO_DECODE_DST_KHRIMAGE_LAYOUT_VIDEO_DECODE_SRC_KHRIMAGE_LAYOUT_VIDEO_DECODE_DPB_KHRIMAGE_LAYOUT_SHARED_PRESENT_KHRIMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMALIMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMALIMAGE_LAYOUT_FRAGMENT_DENSITY_MAP_OPTIMAL_EXTIMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHRIMAGE_LAYOUT_RENDERING_LOCAL_READ_KHRIMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMALIMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMALIMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMALIMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMALIMAGE_LAYOUT_VIDEO_ENCODE_DST_KHRIMAGE_LAYOUT_VIDEO_ENCODE_SRC_KHRIMAGE_LAYOUT_VIDEO_ENCODE_DPB_KHRIMAGE_LAYOUT_READ_ONLY_OPTIMALIMAGE_LAYOUT_ATTACHMENT_OPTIMALIMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT"
...
var _ImageLayout_map = map[ImageLayout]string{
	...
	1000232000: _ImageLayout_name[668:705],
	1000241000: _ImageLayout_name[705:742],
	1000241001: _ImageLayout_name[742:778],
	1000241002: _ImageLayout_name[778:817],
	1000241003: _ImageLayout_name[817:855],
	1000299000: _ImageLayout_name[855:888],
	1000299001: _ImageLayout_name[888:921],
	1000299002: _ImageLayout_name[921:954],
	1000314000: _ImageLayout_name[954:984],
	1000314001: _ImageLayout_name[984:1015],
	1000339000: _ImageLayout_name[1015:1064],
}
...
const _ImageUsageFlagBits_name = "IMAGE_USAGE_TRANSFER_SRC_BITIMAGE_USAGE_TRANSFER_DST_BITIMAGE_USAGE_SAMPLED_BITIMAGE_USAGE_STORAGE_BITIMAGE_USAGE_COLOR_ATTACHMENT_BITIMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BITIMAGE_USAGE_TRANSIENT_ATTACHMENT_BITIMAGE_USAGE_INPUT_ATTACHMENT_BITIMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRIMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXTIMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHRIMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHRIMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHRIMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHRIMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHRIMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHRIMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEIIMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTIMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOMIMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOMIMAGE_USAGE_HOST_TRANSFER_BIT_EXT"
...
var _ImageUsageFlagBits_map = map[ImageUsageFlagBits]string{
	...
	4194304: _ImageUsageFlagBits_name[705:738],
}
...
const _LineRasterizationModeKHR_name = "LINE_RASTERIZATION_MODE_DEFAULT_KHRLINE_RASTERIZATION_MODE_RECTANGULAR_KHRLINE_RASTERIZATION_MODE_BRESENHAM_KHRLINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_KHR"

var _LineRasterizationModeKHR_index = [...]uint8{0, 35, 74, 111, 157}

func (i LineRasterizationModeKHR) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_LineRasterizationModeKHR_index)-1 {
		return "LineRasterizationModeKHR(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _LineRasterizationModeKHR_name[_LineRasterizationModeKHR_index[idx]:_LineRasterizationModeKHR_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i MemoryHeapFlagBits) String() string {
	idx := int(i) - 1
	if i < 1 || idx >= len(_MemoryHeapFlagBits_index)-1 {
		return "MemoryHeapFlagBits(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _MemoryHeapFlagBits_name[_MemoryHeapFlagBits_index[idx]:_MemoryHeapFlagBits_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
