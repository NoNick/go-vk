...
func (i PipelineRobustnessBufferBehaviorEXT) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_PipelineRobustnessBufferBehaviorEXT_index)-1 {
		return "PipelineRobustnessBufferBehaviorEXT(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _PipelineRobustnessBufferBehaviorEXT_name[_PipelineRobustnessBufferBehaviorEXT_index[idx]:_PipelineRobustnessBufferBehaviorEXT_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i PipelineRobustnessImageBehaviorEXT) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_PipelineRobustnessImageBehaviorEXT_index)-1 {
		return "PipelineRobustnessImageBehaviorEXT(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _PipelineRobustnessImageBehaviorEXT_name[_PipelineRobustnessImageBehaviorEXT_index[idx]:_PipelineRobustnessImageBehaviorEXT_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
const _PipelineStageFlagBits_name = "PIPELINE_STAGE_NONEPIPELINE_STAGE_TOP_OF_PIPE_BITPIPELINE_STAGE_DRAW_INDIRECT_BITPIPELINE_STAGE_VERTEX_INPUT_BITPIPELINE_STAGE_VERTEX_SHADER_BITPIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BITPIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BITPIPELINE_STAGE_GEOMETRY_SHADER_BITPIPELINE_STAGE_FRAGMENT_SHADER_BITPIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BITPIPELINE_STAGE_LATE_FRAGMENT_TESTS_BITPIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BITPIPELINE_STAGE_COMPUTE_SHADER_BITPIPELINE_STAGE_TRANSFER_BITPIPELINE_STAGE_BOTTOM_OF_PIPE_BITPIPELINE_STAGE_HOST_BITPIPELINE_STAGE_ALL_GRAPHICS_BITPIPELINE_STAGE_ALL_COMMANDS_BITPIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NVPIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXTPIPELINE_STAGE_TASK_SHADER_BIT_EXTPIPELINE_STAGE_MESH_SHADER_BIT_EXTPIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHRPIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRPIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXTPIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXTPIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR"
...
var _PipelineStageFlagBits_map = map[PipelineStageFlagBits]string{
	...
	131072:   _PipelineStageFlagBits_name[604:644],
	262144:   _PipelineStageFlagBits_name[644:688],
	524288:   _PipelineStageFlagBits_name[688:722],
	1048576:  _PipelineStageFlagBits_name[722:756],
	2097152:  _PipelineStageFlagBits_name[756:797],
	4194304:  _PipelineStageFlagBits_name[797:852],
	8388608:  _PipelineStageFlagBits_name[852:899],
	16777216: _PipelineStageFlagBits_name[899:940],
	33554432: _PipelineStageFlagBits_name[940:991],
}
...
const _PipelineStageFlagBits2_name = "PIPELINE_STAGE_2_NONEPIPELINE_STAGE_2_TOP_OF_PIPE_BITPIPELINE_STAGE_2_DRAW_INDIRECT_BITPIPELINE_STAGE_2_VERTEX_INPUT_BITPIPELINE_STAGE_2_VERTEX_SHADER_BITPIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BITPIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BITPIPELINE_STAGE_2_GEOMETRY_SHADER_BITPIPELINE_STAGE_2_FRAGMENT_SHADER_BITPIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BITPIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BITPIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BITPIPELINE_STAGE_2_COMPUTE_SHADER_BITPIPELINE_STAGE_2_ALL_TRANSFER_BITPIPELINE_STAGE_2_BOTTOM_OF_PIPE_BITPIPELINE_STAGE_2_HOST_BITPIPELINE_STAGE_2_ALL_GRAPHICS_BITPIPELINE_STAGE_2_ALL_COMMANDS_BITPIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NVPIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXTPIPELINE_STAGE_2_TASK_SHADER_BIT_EXTPIPELINE_STAGE_2_MESH_SHADER_BIT_EXTPIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHRPIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRPIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXTPIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXTPIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHRPIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHRPIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHRPIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHRPIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NVPIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXTPIPELINE_STAGE_2_COPY_BITPIPELINE_STAGE_2_RESOLVE_BITPIPELINE_STAGE_2_BLIT_BITPIPELINE_STAGE_2_CLEAR_BITPIPELINE_STAGE_2_INDEX_INPUT_BITPIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BITPIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BITPIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEIPIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEIPIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEI"
...
var _PipelineStageFlagBits2_map = map[PipelineStageFlagBits2]string{
	...
	131072:        _PipelineStageFlagBits2_name[644:686],
	262144:        _PipelineStageFlagBits2_name[686:732],
	524288:        _PipelineStageFlagBits2_name[732:768],
	1048576:       _PipelineStageFlagBits2_name[768:804],
	2097152:       _PipelineStageFlagBits2_name[804:847],
	4194304:       _PipelineStageFlagBits2_name[847:904],
	8388608:       _PipelineStageFlagBits2_name[904:953],
	16777216:      _PipelineStageFlagBits2_name[953:996],
	33554432:      _PipelineStageFlagBits2_name[996:1049],
	67108864:      _PipelineStageFlagBits2_name[1049:1086],
	134217728:     _PipelineStageFlagBits2_name[1086:1123],
	268435456:     _PipelineStageFlagBits2_name[1123:1175],
	536870912:     _PipelineStageFlagBits2_name[1175:1211],
	1073741824:    _PipelineStageFlagBits2_name[1211:1250],
	4294967296:    _PipelineStageFlagBits2_name[1250:1275],
	8589934592:    _PipelineStageFlagBits2_name[1275:1303],
	17179869184:   _PipelineStageFlagBits2_name[1303:1328],
	34359738368:   _PipelineStageFlagBits2_name[1328:1354],
	68719476736:   _PipelineStageFlagBits2_name[1354:1386],
	137438953472:  _PipelineStageFlagBits2_name[1386:1429],
	274877906944:  _PipelineStageFlagBits2_name[1429:1475],
	549755813888:  _PipelineStageFlagBits2_name[1475:1517],
	1099511627776: _PipelineStageFlagBits2_name[1517:1560],
	2199023255552: _PipelineStageFlagBits2_name[1560:1610],
}
...
func (i RenderPassCreateFlagBits) String() string {
	idx := int(i) - 2
	if i < 2 || idx >= len(_RenderPassCreateFlagBits_index)-1 {
		return "RenderPassCreateFlagBits(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _RenderPassCreateFlagBits_name[_RenderPassCreateFlagBits_index[idx]:_RenderPassCreateFlagBits_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
const _Result_name = "ERROR_COMPRESSION_EXHAUSTED_EXTERROR_INVALID_VIDEO_STD_PARAMETERS_KHRERROR_INVALID_OPAQUE_CAPTURE_ADDRESSERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXTERROR_NOT_PERMITTED_KHRERROR_FRAGMENTATIONERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXTERROR_INVALID_EXTERNAL_HANDLEERROR_OUT_OF_POOL_MEMORYERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHRERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHRERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHRERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHRERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHRERROR_IMAGE_USAGE_NOT_SUPPORTED_KHRERROR_INVALID_SHADER_NVERROR_VALIDATION_FAILEDERROR_INCOMPATIBLE_DISPLAY_KHRERROR_OUT_OF_DATE_KHRERROR_NATIVE_WINDOW_IN_USE_KHRERROR_SURFACE_LOST_KHRERROR_UNKNOWNERROR_FRAGMENTED_POOLERROR_FORMAT_NOT_SUPPORTEDERROR_TOO_MANY_OBJECTSERROR_INCOMPATIBLE_DRIVERERROR_FEATURE_NOT_PRESENTERROR_EXTENSION_NOT_PRESENTERROR_LAYER_NOT_PRESENTERROR_MEMORY_MAP_FAILEDERROR_DEVICE_LOSTERROR_INITIALIZATION_FAILEDERROR_OUT_OF_DEVICE_MEMORYERROR_OUT_OF_HOST_MEMORYNOT_READYTIMEOUTEVENT_SETEVENT_RESETINCOMPLETESUBOPTIMAL_KHRTHREAD_IDLE_KHRTHREAD_DONE_KHROPERATION_DEFERRED_KHROPERATION_NOT_DEFERRED_KHRPIPELINE_COMPILE_REQUIREDINCOMPATIBLE_SHADER_BINARY_EXT"
...
var _Result_map = map[Result]string{
	...
	1000482000:  _Result_name[1156:1186],
}
