// Code generated by go-vk from vk.xml at 2025-10-25 17:30:04.5332955 +0000 UTC m=+5.267629296. DO NOT EDIT.
...
// ClusterAccelerationStructureOpInputNV: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkClusterAccelerationStructureOpInputNV.html
type ClusterAccelerationStructureOpInputNV struct {
	PClustersBottomLevel   *ClusterAccelerationStructureClustersBottomLevelInputNV
	asPClustersBottomLevel bool
	PTriangleClusters      *ClusterAccelerationStructureTriangleClusterInputNV
	asPTriangleClusters    bool
	PMoveObjects           *ClusterAccelerationStructureMoveObjectsInputNV
	asPMoveObjects         bool
}

func (u *ClusterAccelerationStructureOpInputNV) AsPClustersBottomLevel(ptr *ClusterAccelerationStructureClustersBottomLevelInputNV) {
	u.PClustersBottomLevel = ptr
	u.asPClustersBottomLevel = true
	u.asPTriangleClusters = false
	u.asPMoveObjects = false
}

func (u *ClusterAccelerationStructureOpInputNV) AsPTriangleClusters(ptr *ClusterAccelerationStructureTriangleClusterInputNV) {
	u.PTriangleClusters = ptr
	u.asPClustersBottomLevel = false
	u.asPTriangleClusters = true
	u.asPMoveObjects = false
}

func (u *ClusterAccelerationStructureOpInputNV) AsPMoveObjects(ptr *ClusterAccelerationStructureMoveObjectsInputNV) {
	u.PMoveObjects = ptr
	u.asPClustersBottomLevel = false
	u.asPTriangleClusters = false
	u.asPMoveObjects = true
}

type _vkClusterAccelerationStructureOpInputNV [unsafe.Sizeof((*_vkClusterAccelerationStructureClustersBottomLevelInputNV)(nil))]byte

func (u *ClusterAccelerationStructureOpInputNV) Vulkanize() *_vkClusterAccelerationStructureOpInputNV {
	switch true {
	case u.asPClustersBottomLevel:
		return (*_vkClusterAccelerationStructureOpInputNV)(unsafe.Pointer(&u.PClustersBottomLevel))
	case u.asPTriangleClusters:
		return (*_vkClusterAccelerationStructureOpInputNV)(unsafe.Pointer(&u.PTriangleClusters))
	case u.asPMoveObjects:
		return (*_vkClusterAccelerationStructureOpInputNV)(unsafe.Pointer(&u.PMoveObjects))
	default:
		return &_vkClusterAccelerationStructureOpInputNV{}
	}
}
...
// IndirectCommandsTokenDataEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkIndirectCommandsTokenDataEXT.html
type IndirectCommandsTokenDataEXT struct {
	PPushConstant   *IndirectCommandsPushConstantTokenEXT
	asPPushConstant bool
	PVertexBuffer   *IndirectCommandsVertexBufferTokenEXT
	asPVertexBuffer bool
	PIndexBuffer    *IndirectCommandsIndexBufferTokenEXT
	asPIndexBuffer  bool
	PExecutionSet   *IndirectCommandsExecutionSetTokenEXT
	asPExecutionSet bool
}

func (u *IndirectCommandsTokenDataEXT) AsPPushConstant(ptr *IndirectCommandsPushConstantTokenEXT) {
	u.PPushConstant = ptr
	u.asPPushConstant = true
	u.asPVertexBuffer = false
	u.asPIndexBuffer = false
	u.asPExecutionSet = false
}

func (u *IndirectCommandsTokenDataEXT) AsPVertexBuffer(ptr *IndirectCommandsVertexBufferTokenEXT) {
	u.PVertexBuffer = ptr
	u.asPPushConstant = false
	u.asPVertexBuffer = true
	u.asPIndexBuffer = false
	u.asPExecutionSet = false
}

func (u *IndirectCommandsTokenDataEXT) AsPIndexBuffer(ptr *IndirectCommandsIndexBufferTokenEXT) {
	u.PIndexBuffer = ptr
	u.asPPushConstant = false
	u.asPVertexBuffer = false
	u.asPIndexBuffer = true
	u.asPExecutionSet = false
}

func (u *IndirectCommandsTokenDataEXT) AsPExecutionSet(ptr *IndirectCommandsExecutionSetTokenEXT) {
	u.PExecutionSet = ptr
	u.asPPushConstant = false
	u.asPVertexBuffer = false
	u.asPIndexBuffer = false
	u.asPExecutionSet = true
}

type _vkIndirectCommandsTokenDataEXT [unsafe.Sizeof((*_vkIndirectCommandsPushConstantTokenEXT)(nil))]byte

func (u *IndirectCommandsTokenDataEXT) Vulkanize() *_vkIndirectCommandsTokenDataEXT {
	switch true {
	case u.asPPushConstant:
		return (*_vkIndirectCommandsTokenDataEXT)(unsafe.Pointer(&u.PPushConstant))
	case u.asPVertexBuffer:
		return (*_vkIndirectCommandsTokenDataEXT)(unsafe.Pointer(&u.PVertexBuffer))
	case u.asPIndexBuffer:
		return (*_vkIndirectCommandsTokenDataEXT)(unsafe.Pointer(&u.PIndexBuffer))
	case u.asPExecutionSet:
		return (*_vkIndirectCommandsTokenDataEXT)(unsafe.Pointer(&u.PExecutionSet))
	default:
		return &_vkIndirectCommandsTokenDataEXT{}
	}
}

// IndirectExecutionSetInfoEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkIndirectExecutionSetInfoEXT.html
type IndirectExecutionSetInfoEXT struct {
	PPipelineInfo   *IndirectExecutionSetPipelineInfoEXT
	asPPipelineInfo bool
	PShaderInfo     *IndirectExecutionSetShaderInfoEXT
	asPShaderInfo   bool
}

func (u *IndirectExecutionSetInfoEXT) AsPPipelineInfo(ptr *IndirectExecutionSetPipelineInfoEXT) {
	u.PPipelineInfo = ptr
	u.asPPipelineInfo = true
	u.asPShaderInfo = false
}

func (u *IndirectExecutionSetInfoEXT) AsPShaderInfo(ptr *IndirectExecutionSetShaderInfoEXT) {
	u.PShaderInfo = ptr
	u.asPPipelineInfo = false
	u.asPShaderInfo = true
}

type _vkIndirectExecutionSetInfoEXT [unsafe.Sizeof((*_vkIndirectExecutionSetPipelineInfoEXT)(nil))]byte

func (u *IndirectExecutionSetInfoEXT) Vulkanize() *_vkIndirectExecutionSetInfoEXT {
	switch true {
	case u.asPPipelineInfo:
		return (*_vkIndirectExecutionSetInfoEXT)(unsafe.Pointer(&u.PPipelineInfo))
	case u.asPShaderInfo:
		return (*_vkIndirectExecutionSetInfoEXT)(unsafe.Pointer(&u.PShaderInfo))
	default:
		return &_vkIndirectExecutionSetInfoEXT{}
	}
}
