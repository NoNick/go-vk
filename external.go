// Code generated by go-vk from vk.xml at 2025-10-26 12:24:21.60059222 +0000 UTC m=+4.560375818. DO NOT EDIT.
...
const (
	FALSE                                                        uint32 = 0
	TRUE                                                         uint32 = 1
	MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR                       uint32 = 3
	LUID_SIZE                                                    uint32 = 8
	...
	MAX_PIPELINE_BINARY_KEY_SIZE_KHR                             uint32 = 32
	MAX_DEVICE_GROUP_SIZE                                        uint32 = 32
	MAX_MEMORY_TYPES                                             uint32 = 32
	MAX_SHADER_MODULE_IDENTIFIER_SIZE_EXT                        uint32 = 32
	COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_ALIGNMENT_AMDX          uint32 = 128
	MAX_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_SET_NAME_SIZE_ARM   uint32 = 128
	COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_STRIDE_AMDX             uint32 = 128
	...
	MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR                       uint32 = ^uint32(0)
	SHADER_INDEX_UNUSED_AMDX                                     uint32 = ^uint32(0)
	QUEUE_FAMILY_IGNORED                                         uint32 = ^uint32(0)
	PARTITIONED_ACCELERATION_STRUCTURE_PARTITION_INDEX_GLOBAL_NV uint32 = ^uint32(0)
