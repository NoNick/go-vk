...
const (
	...
	_SwapchainCreateFlagBitsKHR_name_2 = "SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_EXT"
)
...
const (
	...
	_VideoCodecOperationFlagBitsKHR_name_2 = "VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR"
	_VideoCodecOperationFlagBitsKHR_name_3 = "VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR"
)
...
func (i VideoEncodeCapabilityFlagBitsKHR) String() string {
	idx := int(i) - 1
	if i < 1 || idx >= len(_VideoEncodeCapabilityFlagBitsKHR_index)-1 {
		return "VideoEncodeCapabilityFlagBitsKHR(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _VideoEncodeCapabilityFlagBitsKHR_name[_VideoEncodeCapabilityFlagBitsKHR_index[idx]:_VideoEncodeCapabilityFlagBitsKHR_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
