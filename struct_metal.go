...
// Code generated by go-vk from vk.xml at 2025-10-25 17:30:05.999002439 +0000 UTC m=+6.733336205. DO NOT EDIT.
...
// ImportMemoryMetalHandleInfoEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkImportMemoryMetalHandleInfoEXT.html
...
type _vkImportMemoryMetalHandleInfoEXT struct {
	sType      StructureType
	pNext      unsafe.Pointer
	handleType ExternalMemoryHandleTypeFlagBits
	handle     unsafe.Pointer
...
func (s *_vkImportMemoryMetalHandleInfoEXT) Goify() *ImportMemoryMetalHandleInfoEXT {
...
func (s *ImportMemoryMetalHandleInfoEXT) Vulkanize() *_vkImportMemoryMetalHandleInfoEXT {
	if s == nil {
		return nil
	}
	rval := &_vkImportMemoryMetalHandleInfoEXT{
		sType:      STRUCTURE_TYPE_IMPORT_MEMORY_METAL_HANDLE_INFO_EXT, /*c1*/
		pNext:      (unsafe.Pointer)(s.PNext),                          /*cb*/
		handleType: (ExternalMemoryHandleTypeFlagBits)(s.HandleType),   /*cb*/
		handle:     (unsafe.Pointer)(s.Handle),                         /*cb*/
	}
	return rval
}
...
// MemoryGetMetalHandleInfoEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkMemoryGetMetalHandleInfoEXT.html
...
type _vkMemoryGetMetalHandleInfoEXT struct {
	sType      StructureType
	pNext      unsafe.Pointer
	memory     DeviceMemory
	handleType ExternalMemoryHandleTypeFlagBits
...
func (s *_vkMemoryGetMetalHandleInfoEXT) Goify() *MemoryGetMetalHandleInfoEXT {
...
func (s *MemoryGetMetalHandleInfoEXT) Vulkanize() *_vkMemoryGetMetalHandleInfoEXT {
	if s == nil {
		return nil
	}
	rval := &_vkMemoryGetMetalHandleInfoEXT{
		sType:      STRUCTURE_TYPE_MEMORY_GET_METAL_HANDLE_INFO_EXT,  /*c1*/
		pNext:      (unsafe.Pointer)(s.PNext),                        /*cb*/
		memory:     (DeviceMemory)(s.Memory),                         /*cb*/
		handleType: (ExternalMemoryHandleTypeFlagBits)(s.HandleType), /*cb*/
	}
...
// MemoryMetalHandlePropertiesEXT: See https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkMemoryMetalHandlePropertiesEXT.html
...
// WARNING - struct MemoryMetalHandlePropertiesEXT is returned only, which is not yet handled in the binding
type _vkMemoryMetalHandlePropertiesEXT struct {
	sType          StructureType
	pNext          unsafe.Pointer
	memoryTypeBits uint32
}

func (s *_vkMemoryMetalHandlePropertiesEXT) Goify() *MemoryMetalHandlePropertiesEXT {
...
func (s *MemoryMetalHandlePropertiesEXT) Vulkanize() *_vkMemoryMetalHandlePropertiesEXT {
	if s == nil {
		return nil
	}
	rval := &_vkMemoryMetalHandlePropertiesEXT{
		sType:          STRUCTURE_TYPE_MEMORY_METAL_HANDLE_PROPERTIES_EXT, /*c1*/
		pNext:          (unsafe.Pointer)(s.PNext),                         /*cb*/
